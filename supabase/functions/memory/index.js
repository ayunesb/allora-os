    ...
    try {
        ...
        switch (action) {
            ...
            case "get_relevant_memory": {
                ...
                const { data: memories, error } = yield supabase
            ...
            case "get_learning_insights": {
                ...
                const { data: insights, error } = yield supabase
                    .from("bot_interactions")
                ...
                const positiveInteractions = (insights === null || insights === void 0 ? void 0 : insights.filter((i) => i.user_feedback === "positive")) || [];
                const negativeInteractions = (insights === null || insights === void 0 ? void 0 : insights.filter((i) => i.user_feedback === "negative")) || [];
                // Identify topics with positive/negative feedback
                const positiveTopic = positiveInteractions.length > 0
                    ? extractTopic(positiveInteractions[0].user_message)
                    : "";
                const negativeTopic = negativeInteractions.length > 0
