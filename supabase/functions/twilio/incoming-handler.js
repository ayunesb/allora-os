 ...
 */
export function handleIncomingWhatsApp(from, body, messageSid, numMedia, mediaContentType, mediaUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield supabase.from("inbound_messages").insert({
                platform: "whatsapp",
                from_number: from,
            ...
            if (leads && leads.length > 0) {
                ...
                yield supabase.from("unknown_contacts").insert({
                    phone_number: from,
                    last_message: body,
