    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 3:
          ...
          if (!(action === "create-checkout-session")) return [3 /*break*/, 5];
          if (!priceId) {
            throw new Error("Missing priceId parameter");
          }
          origin_1 = req.headers.get("origin") || "http://localhost:8080";
          return [
            4 /*yield*/,
            stripe_1.checkout.sessions.create({
              line_items: [
                {
                  price: priceId,
                  quantity: 1,
              ...
              cancel_url: "".concat(origin_1, "/payment-canceled"),
