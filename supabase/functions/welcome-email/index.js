...
serve((req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!POSTMARK_API_KEY) {
        return new Response(JSON.stringify({ error: "Postmark API key is not configured" }), {
            status: 500,
    ...
    try {
        ...
        const { data: userData, error: userError } = yield supabase.auth.admin.getUserById(userId);
        if (userError || !((_a = userData === null || userData === void 0 ? void 0 : userData.user) === null || _a === void 0 ? void 0 : _a.email)) {
        ...
        const firstName = ((_b = profile.name) === null || _b === void 0 ? void 0 : _b.split(" ")[0]) || "there";
        const companyName = (company === null || company === void 0 ? void 0 : company.name) || profile.company || "your business";
        const riskAppetite = (((_c = company === null || company === void 0 ? void 0 : company.details) === null || _c === void 0 ? void 0 : _c.riskAppetite) ||
    ...
    `;
        ...
        const { error: logError } = yield supabase.from("communications").insert({
            lead_id: userId,
            type: "email",
