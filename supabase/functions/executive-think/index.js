...
serve((req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { prompt, executiveName, executiveRole, userPreferences, memories = [], inboxMessages = [], } = yield req.json();
        // Prepare system message with user preferences, memories, and inbox messages
...
Adapt your decision making and communication style to match these preferences.`;
        ...
        if (inboxMessages && inboxMessages.length > 0) {
            ...
            inboxMessages.forEach((message) => {
                systemContent += `- From ${message.from_executive}: "${message.message_content}"\n`;
            });
            systemContent +=
