...
(0, server_ts_1.serve)(function (req) {
  return __awaiter(void 0, void 0, void 0, function () {
    var url, path, supabase, authHeader, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          supabase = (0, supabase_js_2_7_1_1.createClient)(
            SUPABASE_URL,
            SUPABASE_ANON_KEY,
          );
        ...
        case 15:
          error_1 = _a.sent();
          console.error("Zoom function error:", error_1);
          return [
            2 /*return*/,
...
function handleAuthUrl(req) {
  return __awaiter(this, void 0, void 0, function () {
    var searchParams, redirectUri, companyId, state, authUrl, scopes;
    return __generator(this, function (_a) {
      try {
        ...
        if (!redirectUri || !companyId) {
          throw new Error(
            "Missing required parameters: redirectUri or companyId",
          );
        }
        ...
        return [
          2 /*return*/,
          new Response(JSON.stringify({ url: authUrl.toString() }), {
            headers: __assign(__assign({}, corsHeaders), {
              "Content-Type": "application/json",
            }),
          }),
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fetch("".concat(ZOOM_ACCOUNTS_BASE, "/token"), {
              method: "POST",
              headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Basic ".concat(
                  btoa(
                    "".concat(ZOOM_CLIENT_ID, ":").concat(ZOOM_CLIENT_SECRET),
                  ),
                ),
              },
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            supabase.from("company_zoom_integrations").upsert({
        ...
        case 5:
          ...
          if (upsertError) {
            throw new Error(
              "Failed to store Zoom integration: ".concat(upsertError.message),
            );
          }
          return [
            2 /*return*/,
            new Response(
              JSON.stringify({ success: true, companyId: companyId }),
              {
                headers: __assign(__assign({}, corsHeaders), {
                  "Content-Type": "application/json",
                }),
        ...
        case 6:
          error_2 = _b.sent();
          console.error("Error handling auth callback:", error_2);
          return [
            2 /*return*/,
            new Response(JSON.stringify({ error: error_2.message }), {
              status: 400,
              headers: __assign(__assign({}, corsHeaders), {
                "Content-Type": "application/json",
              }),
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 9:
          ...
          if (updateError) {
            throw new Error(
              "Failed to update Zoom tokens: ".concat(updateError.message),
            );
          }
          return [
            2 /*return*/,
            new Response(
              JSON.stringify({ success: true, needsRefresh: true }),
              {
                headers: __assign(__assign({}, corsHeaders), {
                  "Content-Type": "application/json",
                }),
        ...
        case 10:
          error_3 = _b.sent();
          console.error("Error refreshing token:", error_3);
          return [
            2 /*return*/,
            new Response(JSON.stringify({ error: error_3.message }), {
              status: 400,
              headers: __assign(__assign({}, corsHeaders), {
                "Content-Type": "application/json",
              }),
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 8:
          return [
            4 /*yield*/,
            fetch("".concat(ZOOM_API_BASE, "/users/me/meetings"), {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
        ...
        case 10:
          errorData = _c.sent();
          throw new Error(
            "Failed to create Zoom meeting: ".concat(errorData.message),
          );
        case 11:
          return [4 /*yield*/, meetingResponse.json()];
        case 12:
          ...
          return [
            4 /*yield*/,
            supabase.from("company_zoom_meetings").insert({
              company_id: companyId,
        ...
        case 13:
          ...
          if (insertError) {
            throw new Error(
              "Failed to store meeting: ".concat(insertError.message),
            );
          }
          return [
            2 /*return*/,
        ...
        case 14:
          error_4 = _c.sent();
          console.error("Error creating meeting:", error_4);
          return [
            2 /*return*/,
            new Response(JSON.stringify({ error: error_4.message }), {
              status: 400,
              headers: __assign(__assign({}, corsHeaders), {
                "Content-Type": "application/json",
              }),
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 6:
          error_5 = _a.sent();
          console.error("Error handling webhook:", error_5);
          return [
            2 /*return*/,
            new Response(JSON.stringify({ error: error_5.message }), {
              status: 400,
              headers: __assign(__assign({}, corsHeaders), {
                "Content-Type": "application/json",
              }),
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            fetch("".concat(ZOOM_ACCOUNTS_BASE, "/revoke"), {
              method: "POST",
              headers: {
                "Content-Type": "application/x-www-form-urlencoded",
                Authorization: "Basic ".concat(
        ...
        case 7:
          ...
          if (deleteError) {
            throw new Error(
              "Failed to disconnect Zoom: ".concat(deleteError.message),
            );
          }
          return [
            2 /*return*/,
        ...
        case 8:
          error_6 = _b.sent();
          console.error("Error disconnecting Zoom:", error_6);
          return [
            2 /*return*/,
            new Response(JSON.stringify({ error: error_6.message }), {
              status: 400,
              headers: __assign(__assign({}, corsHeaders), {
                "Content-Type": "application/json",
              }),
