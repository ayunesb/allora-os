...
serve(async (req) => {
  ...
  try {
    ...
    const { role, prompt, model = "gpt-4o-mini" } = await req.json();
...
function getExecutivePersona(role: string) {
  ...
  const personas: Record<string, any> = {
    "CEO": {
      ...
      expertise: ["Strategic Planning", "Business Growth", "Leadership Development", "Organizational Vision"],
      leadership: {
    ...
    "CMO": {
      ...
      expertise: ["Marketing Strategy", "Brand Development", "Digital Marketing", "Customer Experience"],
      leadership: {
    ...
    "CTO": {
      ...
      expertise: ["Technology Strategy", "Software Development", "IT Infrastructure", "Digital Transformation"],
      leadership: {
    ...
    "CFO": {
      ...
      expertise: ["Financial Strategy", "Risk Management", "Investment Analysis", "Cost Optimization"],
      leadership: {
    ...
    "COO": {
      ...
      expertise: ["Operational Efficiency", "Process Optimization", "Supply Chain Management", "Team Coordination"],
      leadership: {
