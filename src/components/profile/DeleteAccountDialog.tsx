      ...
      <Dialog open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Please type <strong>DELETE</strong> to confirm that you understand
              this action is permanent and cannot be undone. All your data,
              including profile information, company data (if you're the last
              admin), and account settings will be permanently deleted.
            </DialogDescription>
          </DialogHeader>
