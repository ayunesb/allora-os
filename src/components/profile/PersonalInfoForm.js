    ...
    return (<div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input id="name" placeholder="Your full name" {...register('name', { required: 'Name is required' })} className={errors.name ? 'border-destructive' : ''}/>
        ...
        <div className="space-y-2">
          ...
          <Input id="email" type="email" placeholder="Your email address" disabled {...register('email')}/>
        ...
        <div className="space-y-2">
          ...
          <Input id="joinDate" value={userCreatedAt ? new Date(userCreatedAt).toLocaleDateString() : 'N/A'} disabled/>
        </div>
      </div>
