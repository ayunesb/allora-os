...
export default function ConnectPlatformsCard({ metaConnected, tiktokConnected, isLoading, onProceed }) {
    ...
    return (<Card>
      ...
      <CardContent className="grid gap-4">
        <div className="grid gap-2">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={handleMetaConnect} disabled={metaConnected || isLoading || metaConnecting}>
              {metaConnecting ? (<>
          ...
          {metaError && (<div className="flex items-center text-red-500 text-sm mt-1">
        ...
        <div className="grid gap-2">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={handleTikTokConnect} disabled={tiktokConnected || isLoading || tiktokConnecting}>
              {tiktokConnecting ? (<>
                  <RefreshCcw className="mr-2 h-4 w-4 animate-spin"/>
                  Connecting...
          ...
          {tiktokError && (<div className="flex items-center text-red-500 text-sm mt-1">
              <AlertCircle className="h-4 w-4 mr-1"/>
      ...
      <CardFooter>
        <Button className="w-full" onClick={onProceed} disabled={!metaConnected && !tiktokConnected}>
