    ...
    return (<Card className="h-full flex flex-col">
      <CardHeader>
        <div className="flex justify-between items-start mb-2">
          <Badge variant="outline" className="px-2 py-0.5 bg-primary/10 text-primary font-normal text-xs">
            {industry}
          </Badge>
        </div>
      ...
      <CardContent className="flex-1 flex flex-col">
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          <div className="grid grid-cols-2 gap-3">
            {results.map((result, index) => (<div key={index} className="flex items-center space-x-2">
...
const OutcomeShowcase = () => {
    ...
    return (<div className="bg-gradient-to-b from-background to-primary/5 py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Real Results, Real Businesses</h2>
