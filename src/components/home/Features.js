...
const Features = () => {
    ...
    return (<div className="container mx-auto px-4 py-12 md:py-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
        {features.map((feature, index) => (<FeatureBlock key={index} emoji={feature.emoji} title={feature.title} description={feature.description} icon={feature.icon} delay={index * 0.2}/>))}
      </div>
    </div>);
};
