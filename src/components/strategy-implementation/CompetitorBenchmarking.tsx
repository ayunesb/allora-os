  ...
  const handleSaveCompetitor = async () => {
    ...
    try {
      if (formState.id) {
        ...
        if (error) throw error;
        setCompetitors((prev) =>
          prev.map((c) => (c.id === formState.id ? { ...c, ...formState } : c)),
        );
        ...
        if (data && data.length > 0) {
          setCompetitors((prev) =>
            [...prev, data[0]].sort((a, b) => b.marketShare - a.marketShare),
          );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) =>
                  handleSliderChange("strengthScore", value)
                }
              />
            </div>
            ...
            <div>
              ...
              <Slider
                ...
                onValueChange={(value) =>
                  handleSliderChange("weaknessScore", value)
                }
              />
            </div>
