...
// Tab components
const OverviewTab = ({ strategyId }: { strategyId?: string }) => (
  <Card>
...
const TimelineTab = ({ strategyId }: { strategyId?: string }) => (
  <Card>
    <CardContent className="pt-6">
...
const RoiTab = ({ strategyId }: { strategyId?: string }) => (
  <Card>
    <CardContent className="pt-6">
...
const ResourcesTab = ({ strategyId }: { strategyId?: string }) => (
  <Card>
    <CardContent className="pt-6">
