      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="description" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Describe this milestone..." rows={3}/>
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Slider id="progress" min={0} max={100} step={5} value={[progress]} onValueChange={(values) => setProgress(values[0])}/>
          </div>
          
          <div className="grid gap-2">
            <Label htmlFor="owner">Owner</Label>
            <Input id="owner" value={owner} onChange={(e) => setOwner(e.target.value)} placeholder="Responsible person"/>
          </div>
        ...
        <DialogFooter className="flex items-center justify-between">
          {milestone && (<Button variant="destructive" onClick={handleDelete} disabled={isSubmitting}>
