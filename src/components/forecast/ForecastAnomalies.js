...
const ForecastAnomalies = ({ anomalies, recommendations, kpiNames }) => {
    ...
    return (<Card className="border-red-500/20 bg-red-500/5">
      <CardHeader>
      ...
      <CardContent>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {anomalies.map((anomaly) => (<Alert key={anomaly.kpi} variant={anomaly.severity === "critical" ? "destructive" : "warning"}>
              ...
              <AlertDescription>
                ...
                {recommendations[anomaly.kpi] && (<p className="mt-2 text-sm font-medium">
