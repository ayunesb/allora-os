...
export function ProductionDataStatus({
  validationResults,
  isValidating,
  onValidate,
}) {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">
            Validate your production data to ensure no test or demo data is
          ...
          <Table className="bg-background border rounded-md text-xs">
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {validationResults.validationDetails.strategies.total}
                </TableCell>
                <TableCell className="text-right">
                  {validationResults.validationDetails.strategies.valid}
                </TableCell>
                <TableCell className="text-right">
                  {validationResults.validationDetails.strategies.cleaned}
                </TableCell>
                  ...
                  <AccordionContent>
                    <ul className="text-xs space-y-1 mt-2 max-h-40 overflow-y-auto">
                      {validationResults.errors.map((error, index) => (
                        <li
                          key={index}
                          className="text-red-600 bg-red-50 p-1 rounded flex items-start"
                        >
                  ...
                  <AccordionContent>
                    <ul className="text-xs space-y-1 mt-2 max-h-40 overflow-y-auto">
                      {validationResults.warnings.map((warning, index) => (
                        <li
                          key={index}
                          className="text-amber-600 bg-amber-50 p-1 rounded flex items-start"
                        >
