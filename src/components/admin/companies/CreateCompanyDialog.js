...
exports.CreateCompanyDialog = CreateCompanyDialog;
...
function CreateCompanyDialog(_a) {
  var _this = this;
  var open = _a.open,
    onOpenChange = _a.onOpenChange,
    onCreateCompany = _a.onCreateCompany;
  ...
  var handleCreateCompany = function () {
    return __awaiter(_this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.trys.push([1, , 3, 4]);
            return [4 /*yield*/, onCreateCompany(newCompany)];
          case 2:
            _a.sent();
            ...
            (0, jsx_runtime_1.jsxs)("div", {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsx)(input_1.Input, {
                  ...
                  onChange: function (e) {
                    return setNewCompany(
                      __assign(__assign({}, newCompany), {
                        name: e.target.value,
                      }),
                    );
                  },
