  ...
  const runValidation = async () => {
    ...
    try {
      ...
      if (result.ready) {
        ...
        toast.error(
          `${result.issues.length} issues found that need to be fixed before going live`,
        );
      }
    } catch (error) {
        ...
        {validationResult ? (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      All validation checks have passed. Your application is
                      ready to go live.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">
                      {validationResult.issues.length} issue(s) need to be
          ...
          <div className="text-center py-6">
            <p className="text-muted-foreground mb-4">
              Run a production readiness check to verify that your application
              is ready for launch. This will validate authentication, database,
              security settings, and API connections.
            </p>
          </div>
        )}
      </CardContent>
