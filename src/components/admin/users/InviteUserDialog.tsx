  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          className={`${isMobileView ? "w-full" : ""} bg-[#5A67D8] hover:bg-[#4C5BC7] text-white`}
        >
      ...
      <DialogContent
        className={`${isMobileView ? "w-[calc(100%-32px)] p-4" : "sm:max-w-md"} bg-[#1A1F2C] text-white border-white/10`}
      >
        <DialogHeader>
