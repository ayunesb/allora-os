    ...
    return (
      <div className="space-y-4">
        {users.map((user) => (
          <div
            key={user.id}
            className="border border-white/10 rounded-md p-4 bg-[#111827] shadow-sm"
          >
      ...
      <Table>
        <TableHeader className="bg-[#1A1F2C]">
          <TableRow className="border-white/10 hover:bg-transparent">
            ...
            <TableHead
              className={`text-gray-400 ${isTabletView ? "hidden lg:table-cell" : ""}`}
            >
              Email
            </TableHead>
        ...
        <TableBody>
          {users.map((user) => (
            ...
            >
              ...
              <TableCell
                className={`text-gray-300 ${isTabletView ? "hidden lg:table-cell" : ""}`}
              >
                {user.email}
              </TableCell>
              <TableCell>
