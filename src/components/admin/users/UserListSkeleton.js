...
export const UserListSkeleton = () => {
    ...
    if (isMobileView) {
        ...
        {Array.from({ length: 5 }).map((_, index) => (<div key={index} className="border border-white/10 rounded-md p-4 bg-[#111827] shadow-sm">
    ...
    return (<div className="rounded-md border border-white/10 overflow-x-auto bg-[#111827]">
      <Table>
        ...
        <TableBody>
          {Array.from({ length: 5 }).map((_, index) => (<TableRow key={index} className="border-white/10">
