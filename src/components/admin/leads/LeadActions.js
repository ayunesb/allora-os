    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.sent();
            sonner_1.toast.success("Lead status updated to ".concat(status));
            return [3 /*break*/, 3];
          case 2:
            error_1 = _a.sent();
            console.error("Failed to update lead status:", error_1);
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_2 = _a.sent();
            console.error("Failed to delete lead:", error_2);
    ...
    children: [
      (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuTrigger, {
        ...
        children: (0, jsx_runtime_1.jsx)(button_1.Button, {
          variant: "ghost",
          size: "icon",
          children: (0, jsx_runtime_1.jsx)(lucide_react_1.MoreHorizontal, {
            className: "h-4 w-4",
          }),
        }),
      }),
      (0, jsx_runtime_1.jsxs)(dropdown_menu_1.DropdownMenuContent, {
        ...
        children: [
          (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuItem, {
            onClick: function () {
              return handleStatusUpdate("new");
            },
            children: "Mark as New",
          }),
          (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuItem, {
            onClick: function () {
              return handleStatusUpdate("contacted");
            },
            children: "Mark as Contacted",
          }),
          (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuItem, {
            onClick: function () {
              return handleStatusUpdate("qualified");
            },
            children: "Mark as Qualified",
          }),
          (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuItem, {
            onClick: function () {
              return handleStatusUpdate("client");
            },
            children: "Mark as Client",
          }),
          (0, jsx_runtime_1.jsx)(dropdown_menu_1.DropdownMenuItem, {
            onClick: function () {
              return handleStatusUpdate("closed");
            },
...
exports.LeadActions = LeadActions;
