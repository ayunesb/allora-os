...
export function getWebhookDefaultPayload(type: WebhookType): any {
  const basePayload = {
 ...
 */
export async function testWebhookAdvanced(url: string, type: WebhookType): Promise<{ success: boolean; message: string; }> {
  if (!url) {
