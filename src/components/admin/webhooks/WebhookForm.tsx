...
export default function WebhookForm({ initialData, onSubmit, isSubmitting = false }: WebhookFormProps) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <Button type="submit" disabled={isSubmitting}>
          {isSubmitting ? 'Saving...' : initialData ? 'Update Webhook' : 'Create Webhook'}
        </Button>
      </form>
    </Form>
  );
