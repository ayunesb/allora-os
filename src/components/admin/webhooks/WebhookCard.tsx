    ...
    return (<Card className="w-full">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          {webhook.created_at && (<div className="text-xs text-muted-foreground flex items-center">
      ...
      <CardContent>
        <div className="space-y-2">
          <div className="text-sm">
            ...
            <a href={webhook.url} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center">
