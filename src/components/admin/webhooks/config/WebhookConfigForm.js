        ...
        <Tabs value={webhookType} onValueChange={onWebhookTypeChange}>
          ...
          <TabsContent value="stripe" className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" size="sm" onClick={() => onDelete?.('stripe')}>
                Delete
              </Button>
              <Button variant="outline" size="sm" onClick={() => onTest?.('stripe')}>
                Test
              </Button>
              <Button size="sm" onClick={() => onSave?.('stripe', { webhook: stripeWebhook, secret: stripeSecret })}>
                Save
              </Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="zapier" className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" size="sm" onClick={() => onDelete?.('zapier')}>
                Delete
              </Button>
              <Button variant="outline" size="sm" onClick={() => onTest?.('zapier')}>
                Test
              </Button>
              <Button size="sm" onClick={() => onSave?.('zapier', { webhook: zapierWebhook })}>
                Save
              </Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="github" className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" size="sm" onClick={() => onDelete?.('github')}>
                Delete
              </Button>
              <Button variant="outline" size="sm" onClick={() => onTest?.('github')}>
                Test
              </Button>
              <Button size="sm" onClick={() => onSave?.('github', { webhook: githubWebhook, secret: githubSecret })}>
                Save
              </Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="slack" className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" size="sm" onClick={() => onDelete?.('slack')}>
                Delete
              </Button>
              <Button variant="outline" size="sm" onClick={() => onTest?.('slack')}>
                Test
              </Button>
              <Button size="sm" onClick={() => onSave?.('slack', { webhook: slackWebhook })}>
                Save
              </Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="custom" className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button variant="outline" size="sm" onClick={() => onDelete?.('custom')}>
                Delete
              </Button>
              <Button variant="outline" size="sm" onClick={() => onTest?.('custom')}>
                Test
              </Button>
              <Button size="sm" onClick={() => onSave?.('custom', { webhook: customWebhook })}>
                Save
              </Button>
            </div>
          </TabsContent>
