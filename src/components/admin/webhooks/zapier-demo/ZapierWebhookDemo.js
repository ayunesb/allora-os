...
const ZapierWebhookDemo = ({ webhookUrl }) => {
    ...
    return (_jsxs(Card, { className: "p-6", children: [_jsx("h3", { className: "text-lg font-medium mb-4", children: "Test Zapier Integration" }), _jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "w-full", children: [_jsxs(TabsList, { className: "grid w-full grid-cols-2", children: [_jsx(TabsTrigger, { value: "manual", children: "Simple Trigger" }), _jsx(TabsTrigger, { value: "business", children: "Business Events" })] }), _jsx(TabsContent, { value: "manual", className: "mt-4", children: _jsx(ManualTriggerContent, { webhookUrl: webhookUrl, onTrigger: handleManualTrigger, isLoading: isLoading, isTriggering: testingEvent }) }), _jsx(TabsContent, { value: "business", className: "mt-4", children: _jsx(BusinessEventContent, { webhookUrl: webhookUrl, onTrigger: handleBusinessEventTrigger, isLoading: isLoading, isTriggering: testingEvent }) })] })] }));
};
