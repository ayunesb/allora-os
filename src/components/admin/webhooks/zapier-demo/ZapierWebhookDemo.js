    ...
    return (<Card className="p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="manual" className="mt-4">
          <ManualTriggerContent webhookUrl={webhookUrl} onTrigger={handleManualTrigger} isLoading={isLoading} isTriggering={testingEvent}/>
        </TabsContent>
        
        <TabsContent value="business" className="mt-4">
          <BusinessEventContent webhookUrl={webhookUrl} onTrigger={handleBusinessEventTrigger} isLoading={isLoading} isTriggering={testingEvent}/>
        </TabsContent>
      </Tabs>
    </Card>);
};
