...
export function WebhookHistoryContent({ events: initialEvents }) {
    ...
    return (<div className="space-y-6">
      {/* Filters */}
      <WebhookEventFilters filters={filter} onFilterChange={handleFilterChange} availableTypes={availableTypes}/>
      
      {/* Event Table */}
      <WebhookEventTable events={filteredEvents} onViewDetail={handleViewEventDetail}/>
      
      {/* Event Details Modal */}
      {selectedEvent && (<EventDetailsModal event={selectedEvent} isOpen={selectedEvent !== null} onClose={handleCloseEventDetail}/>)}
    </div>);
}
