...
export function LaunchButton() {
    ...
    return (<>
      <Button onClick={handleLaunch} size="lg" className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-medium px-6" disabled={isLaunching}>
        {isLaunching ? (<>
