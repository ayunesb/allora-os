...
export declare function VerificationActions({ isChecking, isAddingDemo, isVerifyingTables, isCheckingIndexes, isVerifyingRLS, isVerifyingFunctions, onRunChecks, onAddDemoData, onVerifyTables, onCheckIndexes, onVerifyRLS, onVerifyFunctions, hasResults, hasVerifiedTables, hasVerifiedIndexes, hasVerifiedRLS, hasVerifiedFunctions }: VerificationActionsProps): JSX.Element;
export {};
