  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      >
        <CardContent className="p-4 flex flex-col items-center justify-center text-center">
          <div
            className={`text-4xl font-bold mb-2 ${summary.failed > 0 ? "text-red-600 dark:text-red-500" : ""}`}
          >
            {summary.failed}
          </div>
          <div
            className={`text-sm ${summary.failed > 0 ? "text-red-600 dark:text-red-400" : "text-muted-foreground"}`}
          >
            Failed
          </div>
        </CardContent>
