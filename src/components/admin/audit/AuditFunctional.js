...
exports.AuditFunctional = AuditFunctional;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            _loop_1 = function (i) {
              var digitalTwinExists_1, passed;
                ...
                switch (_b.label) {
                  ...
                  case 1:
                    ...
                    if (items[i].id === "func-7") {
                      try {
                        digitalTwinExists_1 =
                          typeof require("../../../pages/dashboard/DigitalTwin.tsx") ===
                          "object";
                        setItems(function (prev) {
                          return prev.map(function (item, idx) {
                            return idx === i
                              ? __assign(__assign({}, item), {
                                  status: digitalTwinExists_1
                                    ? "passed"
                                    : "failed",
                                })
                              : item;
          ...
          case 5:
            ...
            if (allRequiredPassed) {
              sonner_1.toast.success("Functional tests passed!");
            } else {
              sonner_1.toast.error("Some functional tests failed!");
            }
            return [3 /*break*/, 8];
          case 6:
            error_1 = _a.sent();
            console.error("Functional test error:", error_1);
            onStatusChange("failed");
            sonner_1.toast.error("Error running functional tests");
            return [3 /*break*/, 8];
          case 7:
            setIsRunning(false);
            return [7 /*endfinally*/];
