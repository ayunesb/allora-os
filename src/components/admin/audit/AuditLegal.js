...
function AuditLegal(_a) {
  ...
  var runTest = function () {
    return __awaiter(_this, void 0, void 0, function () {
      var _loop_1, i, requiredItems, allRequiredPassed, error_1;
        ...
        switch (_a.label) {
              ...
              return __generator(this, function (_b) {
                switch (_b.label) {
                  ...
                  case 1:
                    // Wait a short time to simulate check
                    _b.sent();
                    hasDocument = checkForLegalDocument(items[i].id);
                    // Update item status
                    setItems(function (prev) {
                      return prev.map(function (item, idx) {
                        return idx === i
                          ? __assign(__assign({}, item), {
                              status: hasDocument ? "passed" : "failed",
                            })
                          : item;
                      });
                    });
          ...
          case 5:
            ...
            if (allRequiredPassed) {
              sonner_1.toast.success("Legal documents check passed!");
            } else {
              sonner_1.toast.error(
                "Some required legal documents are missing!",
              );
            }
            return [3 /*break*/, 8];
          case 6:
            error_1 = _a.sent();
            console.error("Error checking legal documents:", error_1);
            onStatusChange("failed");
            sonner_1.toast.error("Error checking legal documents");
            return [3 /*break*/, 8];
          case 7:
            setIsRunning(false);
            return [7 /*endfinally*/];
  ...
  var checkForLegalDocument = function (id) {
            ...
            (0, jsx_runtime_1.jsxs)("div", {
              ...
              children: [
                ...
                (0, jsx_runtime_1.jsx)(card_1.CardTitle, {
                  children: "Legal Documents Audit",
                }),
              ],
            }),
