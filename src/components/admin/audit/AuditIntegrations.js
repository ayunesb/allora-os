...
exports.AuditIntegrations = AuditIntegrations;
        ...
        switch (_a.label) {
          ...
          case 5:
            ...
            if (allRequiredPassed) {
              sonner_1.toast.success("Integrations check passed!");
            } else {
              sonner_1.toast.error(
                "Some integrations failed! Please review and fix.",
              );
            }
            return [3 /*break*/, 8];
          case 6:
            error_1 = _a.sent();
            console.error("Integrations check error:", error_1);
            onStatusChange("failed");
            sonner_1.toast.error("Error checking integrations");
            return [3 /*break*/, 8];
          case 7:
            setIsRunning(false);
            return [7 /*endfinally*/];
        ...
        children: (0, jsx_runtime_1.jsxs)("div", {
          ...
          children: [
            (0, jsx_runtime_1.jsxs)("div", {
              ...
              children: [
                (0, jsx_runtime_1.jsx)(lucide_react_1.Plug, {
                  className: "h-5 w-5 text-primary/80",
                }),
                (0, jsx_runtime_1.jsx)(card_1.CardTitle, {
                  children: "Integrations Check",
                }),
              ],
            }),
