      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            sonner_1.toast.success("AI systems check passed!");
            return [3 /*break*/, 8];
          case 6:
            error_1 = _a.sent();
            console.error("AI test error:", error_1);
            onStatusChange("failed");
            sonner_1.toast.error("Error testing AI systems");
            return [3 /*break*/, 8];
          case 7:
            setIsRunning(false);
            return [7 /*endfinally*/];
