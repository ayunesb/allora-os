...
export function PendingVerificationContent({ onResendEmail, isResending, timeLeft }) {
    return (<>
      ...
      <div className="flex justify-center">
        <Button variant="outline" size="sm" onClick={onResendEmail} disabled={isResending || (timeLeft !== null && timeLeft > 0)} className="flex items-center gap-1">
          {isResending ? (<>
