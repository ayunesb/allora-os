...
var VerificationHandler = function (_a) {
  var user = _a.user,
        ...
        switch (_a.label) {
          case 0:
            if (!(user === null || user === void 0 ? void 0 : user.email)) {
              sonner_1.toast.error("Email address is missing", {
                description:
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              (0, authHelpers_1.resendVerificationEmail)(user.email),
            ];
          case 2:
            result = _a.sent();
            if (result.success) {
              sonner_1.toast.success("Verification email sent successfully", {
  ...
  return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {
    children: children(isResending, handleResendVerificationEmail),
  });
};
