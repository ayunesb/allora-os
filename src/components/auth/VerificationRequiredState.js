...
exports.VerificationRequiredState = VerificationRequiredState;
var jsx_runtime_1 = require("react/jsx-runtime");
var lucide_react_1 = require("lucide-react");
var alert_1 = require("@/components/ui/alert");
var button_1 = require("@/components/ui/button");
var sonner_1 = require("sonner");
function VerificationRequiredState(_a) {
  var _this = this;
        ...
        (0, jsx_runtime_1.jsxs)(alert_1.Alert, {
          ...
          children: [
            ...
            (0, jsx_runtime_1.jsx)(alert_1.AlertDescription, {
              children:
                "Please verify your email address before accessing this page. Check your inbox for a verification email.",
            }),
          ],
        }),
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        _a.sent();
                        sonner_1.toast.info(
                          "Session refreshed. If you've verified your email, try again.",
                        );
                        return [2 /*return*/];
                    }
                  });
