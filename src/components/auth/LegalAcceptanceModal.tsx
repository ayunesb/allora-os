    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Please review and accept the following legal agreements to continue
            using Allora AI.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="grid gap-1.5 leading-none">
              ...
              <p className="text-sm text-muted-foreground">
                By checking this box, you consent to receive communications via
                Email, SMS, and WhatsApp from Allora AI.
              </p>
            </div>
          </div>
