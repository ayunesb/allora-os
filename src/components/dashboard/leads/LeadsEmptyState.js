...
export const LeadsEmptyState = () => {
    ...
    return (<Card className="w-full shadow-md">
      ...
      <CardContent className="flex flex-col items-center space-y-6 py-8">
        ...
        <div className="text-center max-w-md">
          <p className="mb-4">
            ...
            You can manually add leads or import them from a CSV file.
          </p>
        </div>
      </CardContent>
      <CardFooter className="flex justify-center gap-4">
        <AddLeadDialog onLeadAdded={() => { }} campaigns={formattedCampaigns} isMobileView={false}/>
