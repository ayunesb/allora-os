    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        {recommendations.map((rec, index) => (
          <Card
            key={index}
            className="border-primary/10 hover:border-primary/30 transition-all"
          >
              ...
              <div className="flex justify-between">
                <div>
                  <div className="flex items-center gap-1 mb-1">
                    ...
                    <Badge
                      variant="outline"
                      className="bg-amber-500/10 text-amber-500 capitalize"
                    >
                      {rec.timeframe}
                    </Badge>
                  </div>
            ...
            <CardContent>
              <div className="mb-4 flex items-start gap-3">
                <Avatar className="h-8 w-8 border border-primary/20">
                  ...
                  />
                  <AvatarFallback>
                    {rec.executiveBot.name.charAt(0)}
                  </AvatarFallback>
                </Avatar>
            ...
            <CardFooter className="flex justify-between border-t pt-4">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link
                  to={`/dashboard/${rec.type === "strategy" ? "strategies" : rec.type === "campaign" ? "campaigns" : "calls"}`}
                >
                  View Details
                </Link>
              </Button>
