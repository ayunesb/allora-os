    ...
    <Card>
      ...
      <CardContent>
        <p className="text-muted-foreground text-sm">
          Your current business strategies are focused on market expansion and
          customer retention. The AI executive team has provided insights based
        ...
        <div className="mt-4 space-y-3">
          <div className="p-3 bg-primary/10 rounded-md">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Focus on existing markets with current products to increase market
              share.
            </p>
          </div>
          <div className="p-3 bg-primary/10 rounded-md">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Develop new products for existing markets based on customer
              feedback.
            </p>
          </div>
        </div>
