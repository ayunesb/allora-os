    ...
    return (<Card>
      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {links.map((link) => (<div key={link.title} className="p-4 flex flex-col items-center justify-center rounded-lg border bg-card text-card-foreground shadow hover:bg-accent hover:text-accent-foreground transition-colors cursor-pointer" onClick={() => handleNavigate(link.path)}>
