...
import { LayoutDashboard, Users, Megaphone, FileText, Phone, Bot, Settings, UserCircle, BarChartHorizontal, Lightbulb, Sparkles, Trophy, File } from 'lucide-react';
const NavItem = ({ to, icon, children, end }) => (<NavLink to={to} end={end} className={({ isActive }) => `flex items-center gap-2 px-3 py-2 rounded-md transition-colors ${isActive
...
export function DashboardTabs() {
    return (<nav className="flex-1 space-y-1">
