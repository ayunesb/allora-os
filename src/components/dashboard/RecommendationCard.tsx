      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between">
          <div className="flex items-center space-x-2">
            <span
              className={`p-1.5 rounded-full ${getImpactColor(recommendation.impact)}`}
            >
          ...
          {recommendation.isImplemented && (
            <span className="text-xs px-2 py-1 bg-green-50 text-green-600 dark:bg-green-900/20 dark:text-green-400 rounded-full font-medium">
              Implemented
            </span>
          )}
        </div>
        <CardDescription>
          {recommendation.aiGenerated && (
            <span className="text-xs bg-blue-50 text-blue-600 dark:bg-blue-900/20 dark:text-blue-400 px-2 py-0.5 rounded-full mr-2">
              AI Generated
            </span>
          )}
