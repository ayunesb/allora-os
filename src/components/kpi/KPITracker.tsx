      ...
      <Card>
        <CardContent className="py-10 text-center">
          <p className="text-muted-foreground">
            No KPI metrics available. Metrics will appear here as they are
            recorded.
          </p>
        </CardContent>
      </Card>
            ...
            <CardContent>
              <div className="flex justify-between items-end">
                ...
                {typeMetrics.length > 1 && (
                  <div
                    className={`text-sm font-medium flex items-center ${trend.isPositive ? "text-green-500" : "text-red-500"}`}
                  >
