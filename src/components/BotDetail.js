...
export default function BotDetail({ bot: initialBot }) {
    ...
    return (<div className="container mx-auto px-4 py-6 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            ...
            <div className="space-y-1 text-center sm:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center sm:justify-start mt-2">
                ...
                {bot.industry && (<Badge variant="outline" className="bg-secondary/10">
                    {bot.industry}
                  </Badge>)}
              </div>
            </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <CardContent className="pt-6">
            ...
            <TabsContent value="info" className="mt-0">
              <BotInfoPanel bot={bot} description={bot.description} specialties={bot.specialties} expertise={bot.expertise}/>
            </TabsContent>
