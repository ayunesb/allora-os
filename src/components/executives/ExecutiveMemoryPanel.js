...
export function ExecutiveMemoryPanel() {
    ...
    return (<Card>
      <CardHeader>
        ...
        <CardDescription>Recent decisions across all executives</CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (<div className="py-4 text-center text-muted-foreground">
            Loading memories...
          </div>) : memories.length === 0 ? (<div className="py-4 text-center text-muted-foreground">
