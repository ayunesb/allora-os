...
export function CustomerJourneyMapper() {
  ...
  const handleAddTouchpoint = (stageId) => {
    ...
    setEditingStage(
      journeyStages.find((stage) => stage.id === stageId) || null,
    );
                            ...
                            <div className="flex justify-between items-start">
                              ...
                              <div className="flex space-x-1">
                                <Button
                                  ...
                                  onClick={() =>
                                    handleEditTouchpoint(stage.id, touchpoint)
                                  }
                                >
              ...
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      Track engagement and conversion metrics across your
                      customer journey
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Define a customer interaction point in the {editingStage?.title}{" "}
              stage
            </DialogDescription>
          </DialogHeader>
          <form
