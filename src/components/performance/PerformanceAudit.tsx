      ...
      <CardContent>
        <div className="space-y-4">
          <div>
            ...
            <Progress value={pageLoadTime !== null ? Math.min(100, 100 - (pageLoadTime / 6) * 100) : 0} className={`h-2 ${getProgressColor(pageLoadStatus)}`}/>
          </div>
          ...
          <div>
            ...
            <Progress value={fcp !== null ? Math.min(100, 100 - (fcp / 5) * 100) : 0} className={`h-2 ${getProgressColor(fcpStatus)}`}/>
          </div>
          ...
          <div>
            ...
            <Progress value={lcp !== null ? Math.min(100, 100 - (lcp / 6) * 100) : 0} className={`h-2 ${getProgressColor(lcpStatus)}`}/>
          </div>
          ...
          <div>
            ...
            <Progress value={cls !== null ? Math.min(100, 100 - (cls / 0.5) * 100) : 0} className={`h-2 ${getProgressColor(clsStatus)}`}/>
          </div>
        </div>
