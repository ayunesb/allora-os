      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div>
            ...
            <Progress
              value={fcp !== null ? Math.min(100, 100 - (fcp / 5) * 100) : 0}
          ...
          <div>
            ...
            <Progress
              value={lcp !== null ? Math.min(100, 100 - (lcp / 6) * 100) : 0}
          ...
          <div>
            ...
            <Progress
              value={cls !== null ? Math.min(100, 100 - (cls / 0.5) * 100) : 0}
        ...
        <div className="text-xs text-muted-foreground mt-4">
          <p>
            Good metrics are shown in green, needs improvement in yellow, and
            poor in red.
          </p>
          <p>
            These metrics are measured in real-time on your current browser
            session.
          </p>
        </div>
      </CardContent>
