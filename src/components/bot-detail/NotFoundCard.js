...
logError = true }) => {
    ...
    }, [navigate, autoRedirectDelay, redirectPath, redirectLabel, resourceType, logError]);
    return (<CardContent className="pt-6 flex flex-col items-center justify-center min-h-[300px]">
      <div className="mb-4 text-destructive">
        <AlertCircle className="h-12 w-12" aria-hidden="true"/>
      </div>
      <h2 className="text-xl font-semibold mb-2" id="not-found-title">{resourceType} not found</h2>
      ...
      {autoRedirectDelay > 0 && (<p className="text-sm text-muted-foreground mt-4">
