...
export default function EmptyState({ onCreateNew }) {
    return (<div className="flex flex-col items-center justify-center p-8 border border-gray-800 bg-gray-900/30 rounded-lg backdrop-blur-sm animate-fadeIn text-center">
      ...
      <Button onClick={onCreateNew} className="bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 px-6">
