...
export function useStrategies() {
    ...
    useEffect(() => {
        const fetchStrategies = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { data: realStrategies, error: fetchError } = yield supabase
                    .from("strategies")
                    .select("*")
                ...
                const strategies = realStrategies && realStrategies.length > 0
                    ? realStrategies
                    : demoStrategies;
                ...
                const aiGeneratedStrategies = strategyInsights.map((insight) => {
                    ...
                    if (insight.description.includes("high-risk") ||
                        insight.description.includes("High risk")) {
                        riskLevel = "High";
                    }
                    else if (insight.description.includes("low-risk") ||
                    ...
                    const executiveBotName = typeof insight.primaryBot === "object"
                        ? ((_a = insight.primaryBot) === null || _a === void 0 ? void 0 : _a.name) || "AI Executive"
    ...
    }, [insights, insightsLoading, profile === null || profile === void 0 ? void 0 : profile.company_id, startTransition]);
