...
export default function LoadingState() {
    ...
    return (<div className={`grid ${getGridClass()} gap-4 sm:gap-6`}>
      {Array.from({ length: getCardCount() }).map((_, index) => (<div key={index} className="border border-white/10 bg-black/40 backdrop-blur-md rounded-lg p-4 sm:p-6 space-y-4">
