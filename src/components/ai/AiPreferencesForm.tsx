...
export function AiPreferencesForm() {
  ...
  const [includesCompetitorAnalysis, setIncludesCompetitorAnalysis] =
    useState(true);
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => setStrategiesPerWeek(value)}
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="1-2" id="weekly-1-2" />
                  <Label htmlFor="weekly-1-2" className="font-normal">
                    1-2 strategies per week
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="3-5" id="weekly-3-5" />
                  <Label htmlFor="weekly-3-5" className="font-normal">
                    3-5 strategies per week
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="5+" id="weekly-5-plus" />
                  <Label htmlFor="weekly-5-plus" className="font-normal">
                    5+ strategies per week
                  </Label>
                </div>
              </RadioGroup>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="industry-data" className="mb-1 block">
                  Use Industry Data
                </Label>
                <p className="text-sm text-muted-foreground">
                  Include market research in strategy creation
                </p>
              </div>
              <Switch
                id="industry-data"
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="competitor-analysis" className="mb-1 block">
                  Competitor Analysis
                </Label>
                <p className="text-sm text-muted-foreground">
                  Include competitor benchmarking in strategies
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="autonomy" className="mb-1 block">
                  Allow Autonomous Implementation
                </Label>
                <p className="text-sm text-muted-foreground">
