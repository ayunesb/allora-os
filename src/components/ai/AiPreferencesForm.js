        ...
        <CardContent className="pt-6">
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <RadioGroup value={strategiesPerWeek} onValueChange={(value) => setStrategiesPerWeek(value)}>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="industry-data" checked={usesIndustryData} onCheckedChange={setUsesIndustryData}/>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="competitor-analysis" checked={includesCompetitorAnalysis} onCheckedChange={setIncludesCompetitorAnalysis}/>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch id="autonomy" checked={allowsAutonomy} onCheckedChange={setAllowsAutonomy}/>
            </div>
