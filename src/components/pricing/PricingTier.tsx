...
const PricingTier = ({
  ...
  const Badge = ({ children, variant }) => {
    ...
    return (
      <div
        className={`py-1 px-4 ${bgColor} ${textColor} text-center text-sm font-medium`}
      >
        {children}
      </div>
    );
  ...
  return (
    <Card
      className={`flex flex-col ${popular ? "border-primary shadow-lg" : isRecommended ? "border-green-500 shadow-lg" : currentPlan ? "border-blue-500 shadow-lg" : ""}`}
    >
