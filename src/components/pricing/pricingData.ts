...
export const featureComparison: FeatureComparisonItem[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Access to full team of AI executives with specialized expertise",
        starter: false,
        growth: true,
        enterprise: true
      },
      {
        ...
        description: "Watch AI executives debate the best strategy for your business",
        starter: false,
        growth: true,
        enterprise: true
      },
      {
        ...
        description: "Create executives modeled on your specific business needs",
        starter: false,
        growth: false,
        enterprise: true
      }
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Yes, we offer annual billing with a 15% discount compared to monthly billing. You can select your preferred billing cycle during checkout."
  },
  {
    question: "Is there a free trial available?",
    answer: "We offer a 14-day money-back guarantee on all plans. If you're not satisfied with the service, you can request a full refund within the first 14 days."
  }
];
