...
export default function CertificationCard({ title, validUntil, iconUrl, alt }: CertificationProps) {
  return (
    <div className="border rounded-md p-4 flex flex-col items-center text-center">
      ...
      <p className="text-sm text-muted-foreground mb-2">Valid until {validUntil}</p>
