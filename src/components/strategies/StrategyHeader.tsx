...
const StrategyHeader = ({ onNewStrategy, isAnyActionPending = false }) => {
    return (<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8 animate-fadeIn">
      ...
      <div className="flex items-center">
        <Button onClick={onNewStrategy} disabled={isAnyActionPending} variant="gradient" className="w-full sm:w-auto shadow-lg hover:shadow-primary/20">
          {isAnyActionPending ? (<>
