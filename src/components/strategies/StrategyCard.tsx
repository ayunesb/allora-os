  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-0 mb-3 sm:mb-4">
        ...
        <span
          className={`self-start sm:self-auto px-3 py-1 rounded-full text-xs font-medium ${getRiskColor(riskLevel)}`}
        >
          {riskLevel} Risk
        </span>
      </div>

      <p className="text-gray-300 mb-4 sm:mb-6 line-clamp-3">
