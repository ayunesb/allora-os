...
export default function AIExecutiveBoardroom({ companyId }) {
    ...
    if (error) {
        return (<IntroductionState sampleDebate={sampleDebate} onStartNewDebate={handleStartNewDebate}/>);
    }
    // Show empty state
    ...
    // Show debate content
    return (<DebateContent topic={topic} summary={summary} discussion={discussion} conclusion={conclusion} onStartNewDebate={handleStartNewDebate}/>);
}
