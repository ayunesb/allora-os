        ...
        <div>
          ...
          <Tabs defaultValue="discussion" className="space-y-4">
            ...
            <TabsContent value="discussion" className="space-y-4">
              {discussion.length > 0 ? (discussion.map((item, index) => (<div key={index} className="flex space-x-4">
                  ...
                  </div>))) : (<p className="text-sm text-muted-foreground">No discussion data available.</p>)}
            </TabsContent>
            <TabsContent value="conclusion">
              {conclusion ? (<p className="text-muted-foreground">{conclusion}</p>) : (<p className="text-sm text-muted-foreground">No conclusion data available.</p>)}
            </TabsContent>
          </Tabs>
        </div>
