    ...
    <Card className="shadow-md">
          ...
          <HelpTooltip
            content={
              <div className="space-y-1">
                <p>
                  Executive debates occasionally require more processing time
                  than expected.
                </p>
                <p>
                  This is typically due to high system load or complexity of the
                  debate topic.
                </p>
              </div>
            }
      ...
      <CardContent className="flex flex-col items-center justify-center py-6">
        ...
        <p className="text-xs text-muted-foreground mt-3">
          If the problem persists after refreshing, try selecting a different
          debate topic or contact support.
        </p>
      </CardContent>
    </Card>
  );
