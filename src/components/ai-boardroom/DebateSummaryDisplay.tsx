              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2">
                    {summary.keyDisagreements.map((point, idx) => (
                      <li
                        key={idx}
                        className="bg-gray-800 border border-gray-700 rounded-lg p-3 text-sm text-gray-300"
                      >
                        {point}
                      </li>
                    ))}
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {summary.alternativeIdeas.map((idea, idx) => (
                      <li
                        key={idx}
                        className="bg-gray-800 border border-gray-700 rounded-lg p-3 text-sm text-gray-300"
                      >
              ...
              {executives.map((exec) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h4 className="font-medium text-white text-center mb-1">
                      {exec.name}
                    </h4>
                      ...
                      <div>
                        ...
                        <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${performance.boldnessScore}%` }}
                          ></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${performance.riskAlignment}%` }}
                          ></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${performance.innovationScore}%` }}
                          ></div>
                        </div>
                      </div>
                    </div>
