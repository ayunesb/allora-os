...
export const LoadingState = ({ title = "AI Executive Boardroom", description = "Simulating a live debate among your AI executives" }) => {
    return (<Card className="shadow-md">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <CardTitle className="text-lg">{title}</CardTitle>
          <HelpTooltip content={<div className="space-y-1">
              <p>Our system is generating a realistic debate between AI executive personas.</p>
              <p>Each executive will represent different business perspectives based on their role.</p>
            </div>}>
