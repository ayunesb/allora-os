      ...
      <Card className="w-full max-w-lg mx-auto border-primary/20 shadow-xl">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            ...
            analyze site usage, and assist in our marketing efforts. See our{" "}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    You can choose to accept or decline cookies. Necessary
                    cookies are always enabled as they are essential for the
              ...
              {isEU && (
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      We detect that you may be browsing from the European
                      Union, where GDPR regulations apply. Please make a cookie
