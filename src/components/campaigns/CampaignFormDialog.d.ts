...
export default function CampaignFormDialog({ open, onOpenChange, onSubmit, defaultValues, isSubmitting, isEditing }: CampaignFormDialogProps): import("react").JSX.Element;
export {};
