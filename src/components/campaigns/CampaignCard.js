    ...
    return (<Card className="overflow-hidden">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <CardDescription className="flex items-center mt-1">
              ...
              {campaign.status && (<Badge variant="outline" className={getStatusColor()}>
                  {campaign.status}
                </Badge>)}
            </CardDescription>
          </div>
      ...
      <CardContent className="pb-2">
        <div className="space-y-4">
          ...
          {campaign.justification && (<div className="bg-muted p-3 rounded-md text-sm">
      ...
      <CardFooter className="flex flex-col space-y-2">
        <div className="w-full flex space-x-2">
          <Button variant="outline" className="flex-1" onClick={() => onEdit(campaign.id)}>
            <Edit className="mr-2 h-4 w-4"/>
            Edit
          </Button>
          
          {onFeedback && campaign.aiGenerated && (<div className="flex space-x-2 flex-1">
              <Button variant="outline" className="flex-1 bg-green-500/10 hover:bg-green-500/20 border-green-500/30" onClick={() => onFeedback(campaign.id, true)}>
                <ThumbsUp className="mr-2 h-4 w-4"/>
                Approve
              </Button>
              <Button variant="outline" className="flex-1 bg-red-500/10 hover:bg-red-500/20 border-red-500/30" onClick={() => onFeedback(campaign.id, false)}>
