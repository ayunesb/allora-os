...
export default function CampaignHeader({ onNewCampaign }) {
    return (<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8 animate-fadeIn">
      ...
      <Button onClick={onNewCampaign} variant="gradient" className="shadow-lg hover:shadow-primary/20">
