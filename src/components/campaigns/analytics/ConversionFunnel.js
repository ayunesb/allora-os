    ...
    return (<div className="space-y-6">
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="h-10 bg-green-500 rounded-md flex items-center justify-center text-white font-medium" style={{ width: `${clickWidth}%` }}>
            Clicks
          </div>
        </div>
        
        {/* Leads (optional) */}
        {data.leads && (<div className="w-full flex flex-col items-center">
            ...
            <div className="h-10 bg-purple-500 rounded-md flex items-center justify-center text-white font-medium" style={{ width: `${leadWidth}%` }}>
              Leads
            </div>
          </div>)}
        
        {/* Opportunities (optional) */}
        {data.opportunities && (<div className="w-full flex flex-col items-center">
            ...
            <div className="h-10 bg-amber-500 rounded-md flex items-center justify-center text-white font-medium" style={{ width: `${opportunityWidth}%` }}>
              Opportunities
            </div>
          </div>)}
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="h-10 bg-red-500 rounded-b-md flex items-center justify-center text-white font-medium" style={{ width: `${conversionWidth}%` }}>
            Conversions
          </div>
        </div>
      </div>
