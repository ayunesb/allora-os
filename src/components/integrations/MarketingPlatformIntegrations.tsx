...
type IntegrationStatus = 'connected' | 'not_connected' | 'premium' | 'coming_soon';
...
interface MarketingPlatform {
  ...
  logo: string;
  category: 'social' | 'email' | 'crm' | 'analytics' | 'advertising' | 'other';
}
...
export function MarketingPlatformIntegrations() {
  ...
  const handleConnect = (platform: MarketingPlatform) => {
  ...
  const handleDisconnect = (platform: MarketingPlatform) => {
