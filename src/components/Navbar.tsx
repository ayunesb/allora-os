...
export const Navbar = () => {
    const { user } = useUser();
    return (<nav className="bg-background border-b border-border/40 px-4 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          {user ? (<div className="flex items-center gap-2">
              <img src={getUserAvatar(user)} alt={`${getUserDisplayName(user)}'s avatar`} className="w-8 h-8 rounded-full"/>
