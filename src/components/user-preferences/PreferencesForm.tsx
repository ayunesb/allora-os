        ...
        <div className="space-y-4">
          <div>
            ...
            {isEditing ? (
              ...
              <Badge variant="outline" className="capitalize px-3 py-1 font-normal">
          ...
          <div>
            ...
            {isEditing ? (
              <Select 
                ...
                onValueChange={(value) => handlePreferenceChange("riskAppetite", value)}
                disabled={isLoading}
              >
                <SelectTrigger className="w-full">
          ...
          <div>
            ...
            {isEditing ? (
              <Select 
                ...
                onValueChange={(value) => handlePreferenceChange("technicalLevel", value)}
                disabled={isLoading}
              >
                <SelectTrigger className="w-full">
          ...
          <div>
            ...
            {isEditing ? (
              <Select 
                ...
                onValueChange={(value) => handlePreferenceChange("focusArea", value)}
                disabled={isLoading}
              >
                <SelectTrigger className="w-full">
          ...
          <div>
            ...
            {isEditing ? (
              <Select 
                ...
                onValueChange={(value) => handlePreferenceChange("modelPreference", value)}
                disabled={isLoading}
              >
                <SelectTrigger className="w-full">
