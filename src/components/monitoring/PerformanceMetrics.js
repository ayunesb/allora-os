        ...
        <Tabs defaultValue="gauges" value={selectedTab} onValueChange={setSelectedTab}>
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge className={getStatusColor(cpuUsage, 70, 90)}>
                    {cpuUsage.toFixed(1)}%
                  </Badge>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge className={getStatusColor(memoryUsage, 80, 95)}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge className={getStatusColor(apiResponseTime, 300, 800)}>
          ...
          <TabsContent value="timings">
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={formattedTimingData} margin={{
            top: 20,
            right: 30,
            left: 20,
            bottom: 70,
                  ...
                  <Tooltip />
                  <Bar dataKey="duration" fill="#8884d8" name="Duration (ms)" isAnimationActive={false}/>
                </BarChart>
              </ResponsiveContainer>
            </div>
          </TabsContent>
          ...
          <TabsContent value="history">
            ...
            bottom: 20,
                  ...
                  <Tooltip />
                  <Line yAxisId="left" type="monotone" dataKey="cpu" name="CPU Usage (%)" stroke="#8884d8" activeDot={{ r: 8 }}/>
                  <Line yAxisId="left" type="monotone" dataKey="memory" name="Memory (%)" stroke="#82ca9d"/>
                  <Line yAxisId="right" type="monotone" dataKey="apiTime" name="API Time (ms)" stroke="#ffc658"/>
                </LineChart>
              </ResponsiveContainer>
            </div>
          </TabsContent>
