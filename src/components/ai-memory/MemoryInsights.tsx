    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        {isLoading ? (
          ...
          <>
            ...
            {insights.negativeTopic && (
              <div className="p-3 border rounded-md bg-amber-50">
                <div className="text-sm font-medium mb-1 text-amber-700">
          ...
          <div className="text-center py-3 text-muted-foreground">
            No learning insights available yet. Continue interacting with the AI
            advisors to generate insights.
          </div>
        )}
      </CardContent>
      ...
      <CardFooter>
        ...
        <Button
          variant="outline"
          size="sm"
          disabled={isLoading || !preferences?.enableLearning}
          onClick={() => window.open("/dashboard/ai-settings", "_self")}
        >
