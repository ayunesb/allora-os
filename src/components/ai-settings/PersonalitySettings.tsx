...
export function PersonalitySettings({ botPersonalities, onUpdatePersonality }) {
  ...
  const currentBot =
    botPersonalities.find((bot) => bot.botId === activeBot) ||
    botPersonalities[0];
    ...
    return (
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            No AI executives found. Please add executives first.
          </CardDescription>
        </CardHeader>
      </Card>
    );
