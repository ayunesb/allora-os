...
export const PluginEvolutionPanel = ({ pluginId }: { pluginId: string }) => {
    ...
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      ...
      <div>
        ...
        <ul className="space-y-2 mt-2">
          {evolutions.map((e) => (
            <li key={e.id} className="p-3 bg-muted rounded">
      ...
      <div>
        ...
        <ul className="space-y-2 mt-2">
          {logs.map((log) => (
            <li key={log.id} className="p-3 border rounded text-sm">
