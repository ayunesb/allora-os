...
const PluginLeaderboard: React.FC<PluginLeaderboardProps> = ({
  children,
  variant = "default",
  size = "large",
}) => {
      ...
      <Card className={className}>
        ...
        <CardContent>
          <p className="text-center text-muted-foreground py-8">
            No plugin impact data available yet. Install and use plugins to see
            their ROI.
          </p>
        </CardContent>
      </Card>
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  {plugin.usage_count} uses • Avg. value: $
