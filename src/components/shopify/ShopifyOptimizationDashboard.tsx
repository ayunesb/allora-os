...
} from "@/utils/shopifyOptimization";
...
export default function ShopifyOptimizationDashboard({ storeId }) {
      ...
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-6">
            We couldn't analyze your Shopify store. Please check your
            connection.
          </p>
  ...
  const implementedCount = report.recommendations.filter(
    (rec) => rec.implemented,
  ).length;
            ...
            <CardTitle className="text-3xl">
              {
                report.recommendations.filter(
                  (rec) => rec.impact === "high" && !rec.implemented,
                ).length
              }
            </CardTitle>
          </CardHeader>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="flex items-center mb-1">
                        ...
                        <span
                          className={`ml-2 text-xs font-medium ${getImpactColor(recommendation.impact)}`}
                        >
                          {recommendation.impact.toUpperCase()} IMPACT
                        </span>
                        <span
                          className={`ml-2 text-xs font-medium ${getEffortColor(recommendation.effort)}`}
                        >
                    ...
                    >
                      {implementing === recommendation.id ? (
                        ...
                        <>
                          ...
                          Implement{" "}
                          {recommendation.automated ? "Automatically" : "Now"}
                        </>
                      )}
                    </Button>
                  )}
