...
export function AccessibilitySettings() {
  const { preferences, updatePreference, applyAccessibilityClasses } =
    useAccessibility();
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-row items-center justify-between space-y-0">
          <div className="space-y-0.5">
            <Label htmlFor="feedback-notifications">
        ...
        <div className="pt-4 border-t border-border">
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            <p>
              <kbd className="px-1 py-0.5 bg-muted rounded border">Alt</kbd> +{" "}
              <kbd className="px-1 py-0.5 bg-muted rounded border">A</kbd> =
              Show accessibility menu
            </p>
            <p>
              <kbd className="px-1 py-0.5 bg-muted rounded border">Alt</kbd> +{" "}
              <kbd className="px-1 py-0.5 bg-muted rounded border">C</kbd> =
              Toggle high contrast
            </p>
            <p>
              <kbd className="px-1 py-0.5 bg-muted rounded border">Alt</kbd> +{" "}
              <kbd className="px-1 py-0.5 bg-muted rounded border">T</kbd> =
              Toggle large text
            </p>
            <p>
              <kbd className="px-1 py-0.5 bg-muted rounded border">Alt</kbd> +{" "}
              <kbd className="px-1 py-0.5 bg-muted rounded border">M</kbd> =
