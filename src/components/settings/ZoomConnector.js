    ...
    return (<Card>
      ...
      <CardContent>
        {isLoading ? (<div className="flex justify-center py-4">
          ...
          </div>) : isConnected ? (<div className="space-y-4">
            ...
            {integration && (<div className="text-sm text-muted-foreground space-y-2">
      ...
      <CardFooter>
        {isConnected ? (<div className="flex flex-col sm:flex-row gap-2 w-full">
            <Button variant="outline" className="w-full sm:w-auto" onClick={handleDisconnect}>
              Disconnect Zoom
            </Button>
            <Button variant="outline" className="w-full sm:w-auto" onClick={() => window.open('https://zoom.us/meeting', '_blank')}>
              <ExternalLink className="mr-2 h-4 w-4"/>
              Open Zoom Dashboard
            </Button>
          </div>) : (<Button onClick={handleConnect} disabled={isConnecting} className="w-full sm:w-auto">
            {isConnecting ? (<>
