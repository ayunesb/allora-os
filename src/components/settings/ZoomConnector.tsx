      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            {integration && (
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                <p>
                  Last updated:{" "}
                  {formatDistanceToNow(new Date(integration.updated_at), {
                    addSuffix: true,
                  })}
                </p>
              </div>
            ...
            <div className="text-sm text-muted-foreground">
              <p>
                Allora AI can now create and manage Zoom meetings on your
                behalf.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              <p>
                Connect your Zoom account to enable Allora AI to create and
