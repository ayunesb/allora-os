...
function AiCallScriptFeedback(_a) {
  ...
  var trackScriptFeedback = (0, useCallScriptTracking_1.useCallScriptTracking)()
    .trackScriptFeedback;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              trackScriptFeedback(id, title, type, isPositive, primaryBot),
            ];
          case 2:
            _a.sent();
            return [3 /*break*/, 5];
