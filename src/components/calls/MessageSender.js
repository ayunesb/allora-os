...
function MessageSender(_a) {
  ...
  var _c = (0, react_1.useState)(false),
    isSendingMessage = _c[0],
    setIsSendingMessage = _c[1];
          ...
          case 1:
            ...
            if (user === null || user === void 0 ? void 0 : user.id) {
              trackAction(
                ...
                phoneNumber,
                "sms_message",
                { phoneNumber: phoneNumber, messageLength: message.length },
              );
            }
            return [
              4 /*yield*/,
              (0, twilioHelpers_1.sendSMS)(phoneNumber, message),
            ];
          case 2:
            result = _a.sent();
            if (result) {
              sonner_1.toast.success("Message sent successfully");
              setMessage("");
            }
            return [3 /*break*/, 5];
          case 3:
            error_1 = _a.sent();
            console.error("SMS error:", error_1);
  ...
  return (0, jsx_runtime_1.jsxs)(card_1.Card, {
    children: [
      (0, jsx_runtime_1.jsxs)(card_1.CardHeader, {
        children: [
          (0, jsx_runtime_1.jsx)(card_1.CardTitle, { children: "Send SMS" }),
          (0, jsx_runtime_1.jsx)(card_1.CardDescription, {
            children: "Send text messages to leads",
          }),
        ],
      }),
