...
import { upgradeExecutiveBot, UpgradedExecutiveBot } from '@/utils/executive-os/integrationService';
...
export function UpgradeExecutiveBot({ botName, botRole, onUpgradeComplete }: UpgradeExecutiveBotProps) {
  const [isLoading, setIsLoading] = useState(false);
  const [isUpgraded, setIsUpgraded] = useState(false);
  const [upgradedBot, setUpgradedBot] = useState<UpgradedExecutiveBot | null>(null);
        ...
        {isUpgraded && upgradedBot ? (
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-1 pt-1">
              {upgradedBot.personalityTraits.map((trait, i) => (
