        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Our AI executives model the thinking and expertise of world-class
              business leaders. They analyze your business context and provide
              personalized guidance on strategies, decisions, and growth
              opportunities.
            </p>
          </div>
        </div>
