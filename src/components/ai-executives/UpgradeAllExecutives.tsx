...
import { upgradeAllExecutiveBots, UpgradedExecutiveBot } from '@/utils/executive-os/integrationService';
...
export function UpgradeAllExecutives({ onUpgradeComplete }: UpgradeAllExecutivesProps) {
  ...
  const getAllExecutives = () => {
    const executives: Array<{name: string, role: string}> = [];
