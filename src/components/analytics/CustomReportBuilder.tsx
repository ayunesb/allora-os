...
import { PlusCircle, Save, Trash, Download, Settings, Layout } from "lucide-react";
...
export function CustomReportBuilder() {
  ...
  const [newElement, setNewElement] = useState<Partial<ReportElement>>({
    type: "basic",
    chartType: "line",
    dataSource: "leads"
  });
  ...
  const getDemoData = (dataSource: string, chartType: string) => {
    switch (dataSource) {
      case "leads":
        if (chartType === "funnel") {
          return [
  ...
  const renderReportElement = (element: ReportElement) => {
    ...
    return (
      <AnalyticsChart
        title={element.title}
        description={`Data source: ${dataSources.find(ds => ds.id === element.dataSource)?.name}`}
        chartType={element.chartType as any}
        data={data}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="builder" className="space-y-6">
                ...
                <div className="space-y-4 py-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setNewElement({...newElement, dataSource: value})}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setNewElement({...newElement, chartType: value})}
                    >
          ...
          {reportElements.length === 0 ? (
            <div className="border border-dashed rounded-md p-8 text-center bg-background text-muted-foreground">
