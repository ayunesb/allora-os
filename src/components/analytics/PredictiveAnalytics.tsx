...
export function PredictiveAnalytics({ onRefresh }: PredictiveAnalyticsProps) {
  ...
  const generatePredictionData = (metric: string, timeframe: string): PredictionDataPoint[] => {
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-1/3">
            ...
            <Slider
              ...
              onValueCommit={() => setPredictionData(generatePredictionData(selectedMetric, timeframe))}
              className="mt-2"
            />
          </div>
        </div>
        ...
        <div className="my-4 h-80">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                formatter={(value: number) => [formatTooltipValue(value), getMetricName()]}
