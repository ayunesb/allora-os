  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          AI-powered forecasting of future business metrics based on historical
          data
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
                ...
                <TooltipUI>
                  ...
                  <TooltipContent>
                    <p className="max-w-xs">
                      ...
                      ranges. Lower values give narrower ranges but higher
                      uncertainty.
                    </p>
                  </TooltipContent>
                </TooltipUI>
        ...
        <div className="bg-muted/50 p-3 rounded-md flex items-start space-x-2">
          ...
          <div className="text-sm">
            ...
            historical data and AI modeling. Actual results may vary. The
            confidence interval ({confidenceLevel}%) indicates the range within
            which future values are expected to fall.
          </div>
        </div>
      </CardContent>
