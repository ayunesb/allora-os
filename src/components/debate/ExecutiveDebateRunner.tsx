...
export default function ExecutiveDebateRunner() {
  ...
  const [debateResult, setDebateResult] = useState<DebateSessionResult | null>(null);
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  {debateResult.summary.topRisks.map((risk, i) => (
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1">
                  {debateResult.summary.topOpportunities.map((opp, i) => (
            ...
            <div className="space-y-4">
              ...
              {debateResult.debates.map((debate, i) => (
                <div key={i} className="border rounded-lg p-3 bg-muted/20">
                  <div className="flex justify-between mb-2">
                    ...
                    <div className={`px-2 py-0.5 rounded text-xs font-medium ${
                      debate.stance === "For" ? "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300" :
