    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Connect your Meta and TikTok ad accounts to help {companyName} AI
          provide more targeted strategy recommendations
        </p>
      </div>
      ...
      <div className="text-sm text-muted-foreground mt-4">
        <p>
          * You can skip this step and connect your ad accounts later from the
          dashboard.
        </p>
        <p>
          * Connecting your ad accounts helps our AI provide more personalized
