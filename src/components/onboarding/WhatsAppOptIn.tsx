...
export function WhatsAppOptIn({ onOptInChange, initialValue = false }: WhatsAppOptInProps) {
      ...
      <CardContent>
        <div className="flex items-start space-x-4">
          ...
          <div className="space-y-3">
            <p className="text-sm">
              Our AI executive team can send personalized business recommendations, marketing campaigns, and strategic advice 
              directly to your WhatsApp. All messages are human-like and tailored to your business needs.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              You can opt-out anytime by replying STOP to any message. We respect your privacy and comply with all 
              WhatsApp Business messaging policies. See our <a href="#" className="text-primary hover:underline">Privacy Policy</a> for details.
            </p>
          </div>
        </div>
      </CardContent>
