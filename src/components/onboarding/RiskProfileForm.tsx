    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Select the risk profile that best matches {displayCompanyName}'s
          approach to growth.
        </p>
      </div>
      ...
      >
        <Card
          className={`border ${riskAppetite === "low" ? "border-risk-low-DEFAULT" : "border-muted"}`}
        >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground pl-7">
                  <p>
                    Prioritize steady, reliable growth with minimal financial
                    risk.
                  </p>
                  <p className="mt-1">
        ...
        <Card
          className={`border ${riskAppetite === "medium" ? "border-risk-medium-DEFAULT" : "border-muted"}`}
        >
          <CardContent className="pt-4">
            <div className="flex items-start gap-4">
              <RadioGroupItem
        ...
        <Card
          className={`border ${riskAppetite === "high" ? "border-risk-high-DEFAULT" : "border-muted"}`}
        >
          <CardContent className="pt-4">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground pl-7">
                  ...
                  <p className="mt-1">
                    Embrace innovation and disruptive strategies for maximum
                    growth potential.
                  </p>
                </div>
              </div>
