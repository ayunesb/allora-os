  ...
  return (
    <AccordionItem value="growth">
      ...
      <AccordionContent className="space-y-4 pt-4">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium">User Metrics</label>
          <Input
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium">Strategic Partnerships</label>
          <div className="flex gap-2">
            <Input
              placeholder="Add a partnership"
              value={newItem.partnerships || ""}
              onChange={(e) =>
                setNewItem({ ...newItem, partnerships: e.target.value })
              }
            />
            <Button
              type="button"
