      ...
      <AccordionContent className="space-y-4 pt-4">
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              onChange={(e) =>
                setNewItem({ ...newItem, acquisitionStrategy: e.target.value })
              }
            />
            <Button
              type="button"
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {(companyDetails.acquisitionStrategy || []).map(
              (strategy, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      removeFromArray("acquisitionStrategy", index)
                    }
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              onChange={(e) =>
                setNewItem({ ...newItem, salesChannels: e.target.value })
              }
            />
            <Button
              type="button"
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              handleTextChange("customerRetention", e.target.value)
            }
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              handleTextChange("pricingStrategy", e.target.value)
            }
          />
        </div>
