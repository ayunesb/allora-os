    ...
    <AccordionItem value="market">
      ...
      <AccordionContent className="space-y-4 pt-4">
        <div className="space-y-2">
          <label className="text-sm font-medium">Market Size & Growth</label>
          <Input
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              onChange={(e) =>
                setNewItem({ ...newItem, competitors: e.target.value })
              }
            />
            <Button
              type="button"
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            onChange={(e) =>
              handleTextChange("differentiators", e.target.value)
            }
          />
        </div>

        <div className="space-y-2">
          <label className="text-sm font-medium">Customer Pain Points</label>
          <div className="flex gap-2">
            <Input
              placeholder="Add a pain point"
              value={newItem.painPoints || ""}
              onChange={(e) =>
                setNewItem({ ...newItem, painPoints: e.target.value })
              }
            />
            <Button
              type="button"
