  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Fill in the details below to help our AI better understand your
        business. The more information you provide, the more tailored our
        insights will be.
      </p>
      ...
      <div className="flex justify-between items-center mt-6">
        <div className="text-sm text-muted-foreground italic">
          <p>
            * You can continue with basic information only and update these
            details later.
          </p>
        </div>
