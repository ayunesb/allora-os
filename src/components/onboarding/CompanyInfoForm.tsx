      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            value={companyDetails?.primaryOffering || ''}
            onChange={(e) => handleDetailsChange('primaryOffering', e.target.value)}
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => handleDetailsChange('companySize', value)}
            >
          ...
          <div className="space-y-2">
            ...
            <Select 
              value={companyDetails?.monthlyRevenue || ''} 
              onValueChange={(value) => handleDetailsChange('monthlyRevenue', value)}
            >
        ...
        <div className="space-y-2">
          ...
          <Select 
            value={companyDetails?.geographicMarket || ''} 
            onValueChange={(value) => handleDetailsChange('geographicMarket', value)}
          >
