  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="primary-offering">
            Primary Offering (Products/Services)
          </Label>
          <Input
            id="primary-offering"
            ...
            onChange={(e) =>
              handleDetailsChange("primaryOffering", e.target.value)
            }
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleDetailsChange("companySize", value)
              }
            >
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleDetailsChange("monthlyRevenue", value)
              }
            >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleDetailsChange("geographicMarket", value)
            }
          >
