  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-muted-foreground">
        Based on your risk profile ({riskAppetite}), we've assembled the perfect
        executive team for {companyName}.
      </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    I agree to receive business messages via WhatsApp from
                    Allora AI. I understand I can text STOP at any time to opt
                    out.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    I agree to receive email communications from Allora AI. Each
                    email will include an unsubscribe option.
                  </p>
                </div>
              </div>
            </div>
