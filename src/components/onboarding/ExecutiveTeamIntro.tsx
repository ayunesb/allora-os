...
export default function ExecutiveTeamIntro({ executiveTeamEnabled, setExecutiveTeamEnabled, riskAppetite, companyName, onComplete, isLoading }) {
    ...
    return (<div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <input type="checkbox" id="whatsapp-consent" className="mt-1" checked={whatsAppConsent} onChange={(e) => setWhatsAppConsent(e.target.checked)}/>
                <div>
              ...
              <div className="flex items-start gap-3">
                <input type="checkbox" id="email-consent" className="mt-1" checked={emailConsent} onChange={(e) => setEmailConsent(e.target.checked)}/>
                <div>
      ...
      <div className="flex justify-center mt-8">
        <Button onClick={handleCompleteSetup} disabled={isLoading || isSubmitting} size="lg" className="w-full max-w-md">
      ...
      {errorMessage && (<div className="text-center text-red-500 mt-4">
          {errorMessage}
        </div>)}
    </div>);
}
