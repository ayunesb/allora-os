...
exports.Sheet = React.forwardRef(function (_a, ref) {
  ...
  return (0, jsx_runtime_1.jsx)(
    "div",
    __assign(
      { ref: ref, className: (0, utils_1.cn)("sheet", className) },
      props,
      { children: children },
    ),
  );
...
var SheetContent = React.forwardRef(function (_a, ref) {
  ...
  return (0, jsx_runtime_1.jsxs)(SheetPortal, {
    children: [
      (0, jsx_runtime_1.jsx)(SheetOverlay, {}),
      (0, jsx_runtime_1.jsxs)(
        ...
        __assign(
          ...
          props,
          {
            children: [
              children,
              (0, jsx_runtime_1.jsxs)(SheetPrimitive.Close, {
                className:
