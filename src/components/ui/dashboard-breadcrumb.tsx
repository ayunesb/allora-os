...
export function DashboardBreadcrumb({ rootPath, rootLabel, rootIcon, currentPath, currentLabel }) {
    return (<div className="flex items-center text-sm mb-6 text-muted-foreground">
      ...
      <Link to={rootPath} className="flex items-center hover:text-foreground transition-colors">
