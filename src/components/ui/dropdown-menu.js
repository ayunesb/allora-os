...
exports.DropdownMenu = React.forwardRef(function (_a, ref) {
  ...
  return (0, jsx_runtime_1.jsx)(
    "div",
    __assign(
      { ref: ref, className: (0, utils_1.cn)("dropdown-menu", className) },
      props,
      { children: children },
    ),
  );
...
var DropdownMenuContent = React.forwardRef(function (_a, ref) {
  ...
  return (0, jsx_runtime_1.jsx)(DropdownMenuPrimitive.Portal, {
