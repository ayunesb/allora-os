...
declare const SidebarGroupLabel: React.ForwardRefExoticComponent<React.HTMLAttributes<HTMLParagraphElement> & React.RefAttributes<HTMLParagraphElement>>;
...
declare const SidebarMenuButton: React.ForwardRefExoticComponent<React.HTMLAttributes<HTMLDivElement> & {
    active?: boolean;
    asChild?: boolean;
...
export declare function SidebarProvider({ children, defaultExpanded, }: SidebarProviderProps): React.JSX.Element;
interface SidebarTriggerProps extends React.HTMLAttributes<HTMLButtonElement> {
}
export declare function SidebarTrigger({ className, ...props }: SidebarTriggerProps): React.JSX.Element;
