...
import { MessageSquare, Book, Lightbulb, ListChecks, Target } from "lucide-react";
...
export default function ResponseStylePreferences({ preferences, updatePreference }: ResponseStylePreferencesProps) {
  return (
    <div className="space-y-6">
      <div>
        ...
        <RadioGroup 
          ...
          onValueChange={(value) => updatePreference('responseStyle', value)}
          className="space-y-3"
        >
        ...
        <CardContent className="pt-6 space-y-4">
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => updatePreference('technicalLevel', value)}
            >
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <Switch 
              ...
              onCheckedChange={(checked) => updatePreference('showSources', checked)}
            />
          </div>
          ...
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => updatePreference('focusArea', value)}
            >
