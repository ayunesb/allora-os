...
export default function LearningPreferences({ preferences, updatePreference }: LearningPreferencesProps) {
  ...
  const toggleFeedbackLearning = (enabled: boolean) => {
    updatePreference('enableFeedbackLearning', enabled);
  };
  
  const toggleAutomaticResearch = (enabled: boolean) => {
    updatePreference('enableAutomaticResearch', enabled);
  };
  
  const toggleContentAnalysis = (enabled: boolean) => {
    updatePreference('enableContentAnalysis', enabled);
  };
  
  const toggleKnowledgeAreas = (area: string, checked: boolean) => {
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-start space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => toggleKnowledgeAreas('business', checked as boolean)}
            />
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              id="technology"
              checked={(preferences.knowledgeAreas || []).includes('technology')}
              onCheckedChange={(checked) => toggleKnowledgeAreas('technology', checked as boolean)}
            />
            <div className="grid gap-1.5 leading-none">
              <Label
                htmlFor="technology"
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => toggleKnowledgeAreas('marketing', checked as boolean)}
            />
            <div className="grid gap-1.5 leading-none">
              <Label
                htmlFor="marketing"
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              id="innovation"
              checked={(preferences.knowledgeAreas || []).includes('innovation')}
              onCheckedChange={(checked) => toggleKnowledgeAreas('innovation', checked as boolean)}
            />
            <div className="grid gap-1.5 leading-none">
              <Label
                htmlFor="innovation"
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => toggleKnowledgeAreas('finance', checked as boolean)}
            />
            <div className="grid gap-1.5 leading-none">
              <Label
                htmlFor="finance"
          ...
          <div className="flex items-start space-x-2">
            <Checkbox
              id="operations"
              checked={(preferences.knowledgeAreas || []).includes('operations')}
              onCheckedChange={(checked) => toggleKnowledgeAreas('operations', checked as boolean)}
            />
            <div className="grid gap-1.5 leading-none">
              <Label
                htmlFor="operations"
