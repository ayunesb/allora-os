...
import { AiModelType } from '@/hooks/useAiModelPreferences';
import { Card, CardContent } from "@/components/ui/card";
import { Sparkles, Brain, Cable, Database, Bot } from 'lucide-react';
...
export default function AIModelPreferences({ preferences, updatePreference }: AIModelPreferencesProps) {
