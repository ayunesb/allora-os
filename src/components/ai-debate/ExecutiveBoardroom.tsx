        ...
        <TabsContent value="debate">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                See how our AI executive team analyzed your company's needs and
                debated the best strategic approach
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {debateMessages
                  .filter(
                    (m, i, arr) =>
                      arr.findIndex(
                        (m2) => m2.executive.name === m.executive.name,
                      ) === i,
                  )
                  .map((message) => (
                    <div
                      key={message.executive.name}
        ...
        <TabsContent value="process">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                How our AI executive team approached the analysis of your
                business needs
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="bg-secondary/10 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    Our AI executive team analyzes your business information
                    through multiple perspectives, using industry-specific
                    knowledge and strategic frameworks to provide comprehensive
                    insights.
                  </p>
                </div>
                ...
                <div className="bg-secondary/10 rounded-lg p-4">
                  ...
                  <p className="text-sm">
                    The team integrates your specific business context with
                    market trends, competitive analysis, and growth
                    opportunities to create tailored recommendations.
                  </p>
                </div>
              </div>
            </CardContent>
