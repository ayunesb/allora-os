...
(0, vitest_1.describe)("runTestCompanySetup", function () {
  (0, vitest_1.it)(
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                (0, test_1.runTestCompanySetup)("invalid-email"),
              ];
            case 1:
              result = _a.sent();
              (0, vitest_1.expect)(result.success).toBe(false);
              (0, vitest_1.expect)(result.errorCode).toBe("VALIDATION_ERROR");
              (0, vitest_1.expect)(
                fetchUsers_1.getUserProfileByEmail,
  ...
  (0, vitest_1.it)(
    "should return error when user profile not found",
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, test_1.runTestCompanySetup)("valid@example.com"),
              ];
            case 1:
              result = _a.sent();
              (0, vitest_1.expect)(result.success).toBe(false);
              (0, vitest_1.expect)(result.errorCode).toBe("USER_NOT_FOUND");
              (0, vitest_1.expect)(
                fetchUsers_1.getUserProfileByEmail,
              ).toHaveBeenCalledWith("valid@example.com");
              return [2 /*return*/];
          }
        });
      });
