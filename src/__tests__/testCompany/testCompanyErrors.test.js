...
describe("runTestCompanySetup error handling", () => {
    it("should handle profile update error", () => __awaiter(void 0, void 0, void 0, function* () {
        const mockUser = {
            id: "user-123",
    ...
    it("should handle unexpected exceptions", () => __awaiter(void 0, void 0, void 0, function* () {
