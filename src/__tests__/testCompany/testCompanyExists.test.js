...
(0, vitest_1.describe)(
  "runTestCompanySetup with existing company",
  function () {
    (0, vitest_1.it)("should return existing company if found", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var mockUser, mockCompany, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, vitest_1.expect)(result.companyId).toBe(mockCompany.id);
              (0, vitest_1.expect)(result.companyName).toBe(mockCompany.name);
              (0, vitest_1.expect)(
                client_1.supabase.from,
              ).not.toHaveBeenCalledWith("companies");
              return [2 /*return*/];
          }
        });
      });
