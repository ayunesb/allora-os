...
import { verifyDatabaseTables, verifyRlsPolicies, verifyDatabaseFunctions, displayVerificationResults, } from "@/utils/admin/database-verification";
...
describe("Database Verification Utils", () => {
    ...
    describe("verifyDatabaseTables", () => {
        it("should correctly identify existing tables", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield verifyDatabaseTables();
        ...
        it("should correctly identify missing tables", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle errors during table verification", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("verifyRlsPolicies", () => {
        it("should correctly identify tables with RLS policies", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield verifyRlsPolicies();
            // Should identify tables with RLS enabled
            expect(result.some((p) => p.exists)).toBe(true);
        }));
        it("should correctly identify tables without RLS policies", () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock table existence check
            const mockTableSelectFn = vi.fn().mockResolvedValue({
                data: { table_name: "profiles" },
                error: null,
    ...
    describe("verifyDatabaseFunctions", () => {
        it("should correctly identify existing secure functions", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield verifyDatabaseFunctions();
            // Should identify functions that exist and are secure
            expect(result.length).toBeGreaterThan(0);
            expect(result.some((f) => f.exists && f.isSecure)).toBe(true);
        }));
        it("should correctly identify existing but insecure functions", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should correctly identify missing functions", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should handle fallback for function checking when RPC fails", () => __awaiter(void 0, void 0, void 0, function* () {
