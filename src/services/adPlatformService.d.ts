 ...
 */
export declare function getAdPlatformConnections(): Promise<AdPlatformConnection[]>;
/**
 * Disconnect an ad platform
 */
export declare function disconnectAdPlatform(platform: 'meta' | 'tiktok'): Promise<{
    success: boolean;
    error?: undefined;
} | {
    success: boolean;
