 ...
 */
export declare function fetchSocialMediaPosts(
  companyId: string,
 ...
 */
export declare function fetchSocialMediaPost(
  postId: string,
 ...
 */
export declare function createSocialMediaPost(
  companyId: string,
 ...
 */
export declare function updateSocialMediaPost(
 ...
 * @returns Promise with success status or error message
 */
export declare function approvePost(
  postId: string,
  notes?: string,
): Promise<{
  success: boolean;
 ...
 */
export declare function batchSchedulePosts(
  postIds: string[],
