...
exports.mockAgentLogsTable =
  exports.mockExecutivesTable =
  exports.mockMessages =
  exports.mockExecutives =
    void 0;
/**
...
exports.mockMessages = [
  {
    ...
    message_content:
      "We should discuss the Q3 budget projections before the board meeting.",
    status: "read",
  },
  {
    id: "msg-2",
    ...
    message_content:
      "I've prepared the financial forecast. Let's review it tomorrow morning.",
    status: "read",
  },
  {
    id: "msg-3",
    ...
    to_executive: "Sarah Chen",
    message_content:
      "The new product features are ready for demo. Would you like to see them today?",
    status: "unread",
  },
];
...
exports.mockExecutivesTable = {
  select: jest.fn().mockReturnValue({
    eq: jest.fn().mockReturnValue({
      single: jest
        .fn()
        .mockResolvedValue({ data: exports.mockExecutives[0], error: null }),
    }),
    order: jest.fn().mockReturnThis(),
    limit: jest.fn().mockReturnThis(),
    then: jest
      .fn()
      .mockResolvedValue({ data: exports.mockExecutives, error: null }),
  }),
