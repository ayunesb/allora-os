 ...
 */
export declare function fetchExecutiveInbox(
 ...
 */
export declare function markMessagesAsRead(
  executiveName: string,
): Promise<void>;
/**
 * Sends a message to other executives notifying them of recent messages
 */
export declare function notifyOtherExecutives(
  executiveName: string,
 ...
 */
export declare function sendExecutiveMessage(
 ...
 */
export declare function generateExecutiveMessage(
  executiveName: string,
  role: string,
