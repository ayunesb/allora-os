...
exports.fetchMessagesForExecutive =
  exports.getRecentMessages =
  exports.sendExecutiveMessage =
    void 0;
// Add any existing functions here to avoid breaking changes
var sendExecutiveMessage = function () {
...
var fetchMessagesForExecutive = function (executiveName) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
exports.fetchMessagesForExecutive = fetchMessagesForExecutive;
