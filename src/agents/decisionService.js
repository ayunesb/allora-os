...
exports.saveDecisionToDatabase = saveDecisionToDatabase;
var client_1 = require("@/integrations/supabase/client");
var loggingService_1 = require("@/utils/loggingService");
function getExecutiveDecisions() {
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          loggingService_1.logger.error(
            "Failed to get executive decisions from database",
            error_1,
          );
          return [2 /*return*/, []];
        case 3:
...
function saveDecisionToDatabase(decision) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 1:
          ...
          return [
            2 /*return*/,
            ((_b = data === null || data === void 0 ? void 0 : data[0]) ===
              null || _b === void 0
              ? void 0
              : _b.id) || null,
          ];
        case 2:
          error_2 = _c.sent();
          loggingService_1.logger.error(
            "Failed to save executive decision to database",
            error_2,
            {
