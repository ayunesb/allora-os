 ...
 */
export declare function trainForecastModel(data: number[]): Promise<tf.Sequential>;
/**
 ...
 */
export declare function forecastFuture(model: tf.Sequential, nextX: number): Promise<number>;
/**
 ...
 */
export declare function forecastExecutiveResources(pastResourcePoints: number[]): Promise<number | null>;
/**
 ...
 */
export declare function trainMultiForecastModels(kpiData: Record<string, number[]>): Promise<Record<string, tf.Sequential>>;
/**
 ...
 */
export declare function forecastMultipleFuture(models: Record<string, tf.Sequential>, nextX: number): Promise<Record<string, number>>;
