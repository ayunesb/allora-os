 ...
 */
export async function trainForecastModel(data) {
    try {
 ...
 */
export async function forecastFuture(model, nextX) {
    try {
 ...
 */
export async function forecastExecutiveResources(pastResourcePoints) {
    try {
 ...
 */
export async function trainMultiForecastModels(kpiData) {
    try {
        const models = {};
 ...
 */
export async function forecastMultipleFuture(models, nextX) {
    try {
        const forecasts = {};
