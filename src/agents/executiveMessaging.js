 ...
 */
export async function fetchExecutiveInbox(executiveName) {
 ...
 */
export async function markMessagesAsRead(executiveName) {
 ...
 */
export async function notifyOtherExecutives(executiveName, executiveRole, messages) {
 ...
 */
export async function sendExecutiveMessage(fromExecutive, toExecutive, messageContent) {
    const { error } = await supabase
        .from("executive_messages")
        .insert({
 ...
 */
export async function generateExecutiveMessage(executiveName, role, recipientName, recipientRole, topic) {
