 ...
 */
export async function runDebateSession(task, riskAppetite = 'medium', businessPriority = 'growth') {
    ...
    for (const exec of executives) {
        try {
            ...
            const response = await runExecutiveDebate(exec.name, exec.role, task, riskAppetite, businessPriority);
