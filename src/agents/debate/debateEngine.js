 ...
 */
export async function runExecutiveDebate(executiveName, role, task, riskAppetite = 'medium', businessPriority = 'growth') {
    try {
 ...
 */
export async function saveDebateResult(task, executiveName, role, opinion) {
    try {
