...
exports.default = useDebateMessages;
var react_1 = require("react");
var useMessageOperations_1 = require("./useMessageOperations");
var useBotResponses_1 = require("./useBotResponses");
var useUserPreferences_1 = require("./useUserPreferences");
function useDebateMessages() {
  var _this = this;
  var _a = (0, useMessageOperations_1.useMessageOperations)(),
    ...
    addSystemMessage = _a.addSystemMessage,
    voteMessage = _a.voteMessage,
    toggleFavorite = _a.toggleFavorite;
  var preferences = (0, useUserPreferences_1.useUserPreferences)().preferences;
  var simulateBotResponses = (0, useBotResponses_1.useBotResponses)(
    addMessage,
    setIsLoading,
  ).simulateBotResponses;
  var sendUserMessage = (0, react_1.useCallback)(
    function (content_1, participants_1, topic_1) {
      var args_1 = [];
      ...
      return __awaiter(
        _this,
        __spreadArray([content_1, participants_1, topic_1], args_1, true),
        void 0,
        function (
          content,
          participants,
          ...
          return __generator(this, function (_a) {
            if (!content.trim()) return [2 /*return*/];
            userMessage = {
              id: "msg-".concat(Date.now(), "-user"),
              sender: "You",
              senderId: "user",
              content: content,
              timestamp: new Date(),
