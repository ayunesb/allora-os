...
export function useAuthErrorHandler() {
   ...
   */
  const getUserFriendlyMessage = useCallback((errorType: AuthErrorType, originalMessage?: string): string => {
    switch (errorType) {
  ...
  const handleAuthError = useCallback((
    ...
    const errorMessage = error?.message || error?.error || 'Authentication error';
   ...
   */
  const isErrorType = useCallback((type: AuthErrorType) => {
