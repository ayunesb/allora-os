...
export default function useExecutiveBoardroom() {
    ...
    useEffect(() => {
        const defaultExecutives = [
            ...
            .map((name, index) => {
            var _a;
            const role = ((_a = Object.entries(executiveBots).find(([_, names]) => names.includes(name))) === null || _a === void 0 ? void 0 : _a[0]) || "ceo";
            return {
                id: `exec-${index}`,
                name,
                role,
    ...
    const generateSuggestedTopic = (industry) => __awaiter(this, void 0, void 0, function* () {
        try {
            const mockTopics = {
                Technology: [
    ...
    const startDebate = useCallback((topic) => __awaiter(this, void 0, void 0, function* () {
        if (!topic.trim()) {
        ...
        try {
            const { data, error } = yield supabase
                ...
                context: {
                    industry: (profile === null || profile === void 0 ? void 0 : profile.industry) || "Technology",
                    riskAppetite: (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) || "medium",
                },
            })
                .select("id")
                .single();
    ...
    const simulateExecutiveResponses = (topic) => __awaiter(this, void 0, void 0, function* () {
        const riskAppetite = (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) || "medium";
        const responses = [];
        try {
            for (let i = 0; i < participants.length; i++) {
                const exec = participants[i];
                yield new Promise((resolve) => setTimeout(resolve, 500 + Math.random() * 1500));
    ...
    const simulateDebateInteractions = (topic, previousResponses) => __awaiter(this, void 0, void 0, function* () {
        try {
            for (let i = 0; i < 3; i++) {
                ...
                const respondentIndex = (challengerIndex +
                    1 +
                ...
                const observersIndices = Array.from(Array(participants.length).keys()).filter((idx) => idx !== challengerIndex && idx !== respondentIndex);
                ...
                yield new Promise((resolve) => setTimeout(resolve, 1500 + Math.random() * 1500));
                const response = generateMockResponse(respondent, challenge, (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) || "medium");
    ...
    const generateExecutiveVotes = (topic) => {
        ...
        const newVotes = participants.map((exec) => {
            ...
            const userRiskIsBold = (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) === "high";
            const userRiskIsCautious = (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) === "low";
            let choice;
    ...
    const generateMockResponse = (executive, topic, riskAppetite) => {
        ...
        return (roleResponses[riskAppetite] ||
            roleResponses.medium);
    };
    ...
    const saveStrategyToLibrary = () => __awaiter(this, void 0, void 0, function* () {
        if (!debateSummary || !sessionId || !(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
        ...
        try {
            const { data, error } = yield supabase
                ...
                risk_level: (preferences === null || preferences === void 0 ? void 0 : preferences.riskAppetite) || "Medium",
            })
                .select("id")
                .single();
            if (error)
