...
export function createZoomMeeting(leadId, meetingData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data: result, error } = yield supabase.functions.invoke("communications", {
                body: {
...
// Log a communication
export function logCommunication(leadId, communicationData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data: result, error } = yield supabase.functions.invoke("communications", {
                body: {
...
export function generateAISummary(communicationId, transcriptText) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data: result, error } = yield supabase.functions.invoke("communications", {
                body: {
...
export function updateCommunicationStatus(id, status, notes, outcome) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
