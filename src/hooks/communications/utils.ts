...
export function getUpcomingCommunications(communications: Communication[]): Communication[] {
...
export function getPastCommunications(communications: Communication[]): Communication[] {
  return communications.filter(comm => 
    (comm.status !== 'scheduled') || 
