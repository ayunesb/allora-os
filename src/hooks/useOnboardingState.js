...
export default function useOnboardingState() {
    ...
    const handleComplete = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const enhancedDetails = Object.assign(Object.assign({}, companyDetails), { riskAppetite,
                executiveTeamEnabled, goals: goals });
            console.log("Saving onboarding info:", user.id, companyName, industry, goals, enhancedDetails);
            const result = yield saveOnboardingInfo(user.id, companyName, industry, goals, enhancedDetails);
            if (!result.success) {
