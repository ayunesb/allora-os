...
export function useLinkedInIntegration() {
    ...
    const connectToLinkedIn = () => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { data, error } = yield supabase.functions.invoke("linkedin", {
    ...
    const handleAuthCallback = (code, state) => __awaiter(this, void 0, void 0, function* () {
        try {
            setIsConnecting(true);
    ...
    const searchConnections = (query) => __awaiter(this, void 0, void 0, function* () {
        if (!accessToken) {
    ...
    const importConnections = (selectedConnections, campaignId) => __awaiter(this, void 0, void 0, function* () {
        if (!accessToken || !(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
        ...
        try {
            ...
            const imported = yield Promise.all(selectedConnections.map((connection) => __awaiter(this, void 0, void 0, function* () {
                ...
                const lead = yield createLead(leadData);
