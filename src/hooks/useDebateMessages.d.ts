...
export default function useDebateMessages(): {
    ...
    simulateBotResponses: (participants: DebateParticipant[], topic: string, riskAppetite?: string, businessPriority?: string, preferences?: any) => Promise<void>;
    sendUserMessage: (content: string, participants: DebateParticipant[], topic: string, riskAppetite?: string, businessPriority?: string) => Promise<void>;
