...
export function useVerification(companyId) {
    ...
    const runChecks = () => __awaiter(this, void 0, void 0, function* () {
        ...
        setIsChecking(true);
        try {
            const { data, error } = yield supabase.functions.invoke("verify-launch-readiness", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
            setResults(data);
            setIsReady(((_a = data.overallStatus) === null || _a === void 0 ? void 0 : _a.valid) || false);
            if ((_b = data.overallStatus) === null || _b === void 0 ? void 0 : _b.valid) {
    ...
    // Add demo data
    const handleAddDemoData = () => __awaiter(this, void 0, void 0, function* () {
        if (!companyId) {
        ...
        try {
            const { error } = yield supabase.functions.invoke("add-demo-data", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
    ...
    const verifyRequiredTables = () => __awaiter(this, void 0, void 0, function* () {
        if (!companyId) {
        ...
        try {
            const { data, error } = yield supabase.functions.invoke("verify-database-tables", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
            setResults((prev) => (Object.assign(Object.assign({}, prev), { databaseTables: data.tables })));
    ...
    const checkDatabaseIndexes = () => __awaiter(this, void 0, void 0, function* () {
        if (!companyId) {
        ...
        try {
            const { data, error } = yield supabase.functions.invoke("verify-database-indexes", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
            setResults((prev) => (Object.assign(Object.assign({}, prev), { databaseIndexes: data.indexes })));
    ...
    // Verify RLS policies
    const verifyRLSPolicies = () => __awaiter(this, void 0, void 0, function* () {
        if (!companyId) {
        ...
        try {
            const { data, error } = yield supabase.functions.invoke("verify-rls-policies", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
            setResults((prev) => (Object.assign(Object.assign({}, prev), { rlsPolicies: data.policies })));
    ...
    const verifyDatabaseFunctions = () => __awaiter(this, void 0, void 0, function* () {
        if (!companyId) {
        ...
        try {
            const { data, error } = yield supabase.functions.invoke("verify-database-functions", {
                body: { tenant_id: companyId },
            });
            if (error)
                throw new Error(error.message);
            setResults((prev) => (Object.assign(Object.assign({}, prev), { databaseFunctions: data.functions })));
