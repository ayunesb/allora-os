...
export const useSocialMedia = () => {
    ...
    const fetchPosts = useCallback((filters) => __awaiter(void 0, void 0, void 0, function* () {
        setIsLoading(true);
        setError(null);
        try {
            ...
            setTimeout(() => {
                const filteredPosts = mockPosts.filter((post) => {
                    if ((filters === null || filters === void 0 ? void 0 : filters.search_query) &&
                        !post.title
                            .toLowerCase()
                    ...
                    if ((filters === null || filters === void 0 ? void 0 : filters.platform) && post.platform !== filters.platform) {
                        return false;
                    }
                    if ((filters === null || filters === void 0 ? void 0 : filters.status) && post.status !== filters.status) {
                        return false;
                    }
                    return true;
                });
    ...
    const refreshPosts = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        yield fetchPosts({
    ...
    const updatePost = useCallback((postId, postData) => __awaiter(void 0, void 0, void 0, function* () {
        setIsLoading(true);
        try {
            // In real app, this would be an API call
            setPosts((prev) => prev.map((post) => post.id === postId ? Object.assign(Object.assign({}, post), postData) : post));
            setIsLoading(false);
    ...
    const approve = useCallback((postId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield updatePost(postId, { is_approved: true });
        }
        catch (err) {
