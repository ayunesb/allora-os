...
export const useCompliance = (): ExtendedComplianceContextType => {
  ...
  const extendedContext: ExtendedComplianceContextType = {
    ...
    checkForUpdates:
      ...
      (() => console.warn("checkForUpdates not implemented")),
    setAutoUpdate:
      context.setAutoUpdate ||
      ((v: boolean) => console.warn("setAutoUpdate not implemented", v)),
    ...
    updatePreference:
      ...
      ((key: string, value: any) =>
        console.warn("updatePreference not implemented", key, value)),
    ...
    scheduleComplianceCheck:
      context.scheduleComplianceCheck || (async () => {}),
    ...
    privacyLevel:
      (context.privacyLevel as "standard" | "strict" | "custom") || "standard",
