...
export function useCeoMessage(
  ...
  const [message, setMessage] = useState<CeoMessage>({
    greeting: "",
    strategicOverview: "",
    tags: [],
    actionSteps: "",
    ...
    const generateMessage = async () => {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          let generatedMessage: CeoMessage;
          ...
          if (riskAppetite === 'high') {
            generatedMessage = {
              ...
              tags: ["Disruptive Innovation", "First-Mover Advantage", "Accelerated Growth", "Market Leadership"],
            ...
            generatedMessage = {
              ...
              tags: ["Strategic Growth", "Balanced Portfolio", "Calculated Risks", "Market Expansion"],
            ...
            generatedMessage = {
              ...
              tags: ["Steady Growth", "Risk Mitigation", "Operational Excellence", "Customer Retention"],
