...
export function useCompanyInsights() {
    ...
    useEffect(() => {
        ...
        const generateInsights = () => __awaiter(this, void 0, void 0, function* () {
            try {
                setIsLoading(true);
                setError(null);
...
function generateCompanySpecificInsights(companyName, industry, goals = [], riskAppetite = "Medium") {
    ...
    return [
        // Strategy insight
        {
            ...
            title: strategyTitle,
            description: `A comprehensive growth strategy tailored for ${companyName} in the ${industry} sector, focusing on ${goals.includes("growth")
                ? "market penetration"
                : goals.includes("innovation")
        ...
        // Campaign insight
        {
            ...
            title: campaignTitle,
            description: `Proposal for a high-ROI ${goals.includes("revenue")
                ? "revenue-focused"
                : goals.includes("acquisition")
        ...
        // Call script insight
        {
            ...
            description: `High-conversion call script designed to communicate ${companyName}'s value proposition to ${goals.includes("enterprise")
                ? "enterprise-level"
...
function generateDetailedInsightData(insights, companyName, industry, goals = [], riskAppetite = "Medium") {
    ...
    insights.forEach((insight) => {
        ...
        if (insight.type === "strategy") {
            ...
            reasoning = `This strategy was developed with a primary focus on ${companyName}'s stated goal of ${goals.length > 0 ? goals[0] : "growth"} within the ${industry} sector. Given the ${riskAppetite.toLowerCase()} risk appetite, we've prioritized ${riskAppetite === "High"
            ...
            reasoning = `This campaign was designed to align with ${companyName}'s ${goals.length > 0 ? goals.join(" and ") : "growth"} objectives. The channel selection prioritizes ${goals.includes("revenue")
            ...
            reasoning = `This call script was crafted using proven sales methodologies from top sales experts, with specific adaptations for the ${industry} sector. The script emphasizes ${goals.includes("enterprise")
        ...
        detailedInsights[insight.id] = Object.assign(Object.assign({}, insight), { keyPoints,
            reasoning,
            executiveSummary,
            contributors });
    });
...
function getBotsForRole(...roles) {
    ...
    const primaryBotName = ((_a = executiveBots[primaryRole]) === null || _a === void 0 ? void 0 : _a[0]) ||
        "AI Assistant";
    const primary = {
        name: primaryBotName,
        role: primaryRole,
