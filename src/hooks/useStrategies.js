...
export function useStrategies() {
    ...
    const fetchStrategies = useCallback(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!data || data.length === 0) {
                const demoStrategies = generateDemoStrategies(profile.company_id, profile === null || profile === void 0 ? void 0 : profile.industry);
                ...
                const strategiesWithExecs = data.map((strategy) => {
                    if (!strategy.executiveBot) {
                        return Object.assign(Object.assign({}, strategy), { executiveBot: getRandomExecutive() });
                    }
                    return strategy;
                });
    ...
    }), [profile === null || profile === void 0 ? void 0 : profile.company_id, profile === null || profile === void 0 ? void 0 : profile.industry]);
    ...
    const createStrategy = useCallback((strategyData) => __awaiter(this, void 0, void 0, function* () {
        if (!(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
        ...
        try {
            ...
            const riskValue = strategyData.risk ||
            ...
            const { data, error } = yield supabase
                .from("strategies")
                .insert([
                Object.assign(Object.assign({}, strategyData), { company_id: profile.company_id, risk: riskValue, riskLevel: riskValue, executiveBot, created_at: new Date().toISOString() }),
            ])
                .select();
            if (error) {
                throw error;
    ...
    }), [profile === null || profile === void 0 ? void 0 : profile.company_id, fetchStrategies]);
    const updateStrategy = useCallback((strategyId, updates) => __awaiter(this, void 0, void 0, function* () {
        if (!(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
            toast.error("Company profile not found");
            return false;
        }
        ...
        try {
            ...
            setStrategies((prev) => prev.map((strategy) => strategy.id === strategyId ? Object.assign(Object.assign({}, strategy), updates) : strategy));
            return true;
        }
        catch (err) {
    ...
    const deleteStrategy = useCallback((strategyId) => __awaiter(this, void 0, void 0, function* () {
        if (!(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
            toast.error("Company profile not found");
            return false;
        }
