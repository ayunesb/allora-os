...
export function useAuthErrorHandler() {
     ...
     */
    const getErrorTypeFromMessage = useCallback((error) => {
        var _a;
     ...
     */
    const getUserFriendlyMessage = useCallback((errorType, originalMessage) => {
        switch (errorType) {
            ...
            default:
                return (originalMessage || "An unexpected authentication error occurred.");
        }
    }, []);
    /**
    ...
    const handleAuthError = useCallback((error, options = {}) => {
        ...
        const errorMessage = (error === null || error === void 0 ? void 0 : error.message) || (error === null || error === void 0 ? void 0 : error.error) || "Authentication error";
    ...
    const isErrorType = useCallback((type) => {
        return (lastError === null || lastError === void 0 ? void 0 : lastError.type) === type;
    }, [lastError]);
    return {
        lastError,
        handleAuthError,
