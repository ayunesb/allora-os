...
export function useBotResponses(addMessage, setIsLoading) {
    const simulateBotResponses = useCallback(async (participants, topic, riskAppetite = 'medium', businessPriority = 'growth', preferences) => {
        ...
        try {
            ...
            for (const participant of participants) {
                try {
                    ...
                    const content = await generateBotResponse(participant, topic, riskAppetite, businessPriority);
