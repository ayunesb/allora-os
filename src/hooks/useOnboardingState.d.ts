...
export default function useOnboardingState(): {
    ...
    companyName: string;
    setCompanyName: import("react").Dispatch<import("react").SetStateAction<string>>;
    industry: string;
    ...
    setExecutiveTeamEnabled: import("react").Dispatch<import("react").SetStateAction<boolean>>;
