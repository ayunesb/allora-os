...
exports.useCeoFeedback = useCeoFeedback;
var react_1 = require("react");
var sonner_1 = require("sonner");
var AuthContext_1 = require("@/context/AuthContext");
function useCeoFeedback() {
  var _this = this;
  var _a = (0, react_1.useState)(false),
    isSubmitting = _a[0],
    setIsSubmitting = _a[1];
  var profile = (0, AuthContext_1.useAuth)().profile;
  var provideFeedback = function (isPositive) {
  ...
  return { provideFeedback: provideFeedback, isSubmitting: isSubmitting };
}
