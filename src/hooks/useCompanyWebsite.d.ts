...
export declare function useCompanyWebsite(): {
    ...
    applyScrapedDataToCompanyDetails: (currentDetails: PartialCompanyDetails, companyNameSetter: (name: string) => void, industrySetter: (industry: string) => void) => PartialCompanyDetails;
};
