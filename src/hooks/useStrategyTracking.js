...
export function useStrategyTracking() {
    ...
    const trackApproval = useCallback((strategyId, strategyTitle) => __awaiter(this, void 0, void 0, function* () {
        if (!(user === null || user === void 0 ? void 0 : user.id) || !(profile === null || profile === void 0 ? void 0 : profile.company_id)) {
        ...
        try {
            ...
            const { error } = yield supabase.from("strategy_actions").insert({
    ...
    const trackRejection = useCallback((strategyId, reason) => __awaiter(this, void 0, void 0, function* () {
    ...
    const trackShare = useCallback((strategyId, shareDetails) => __awaiter(this, void 0, void 0, function* () {
        if (!(user === null || user === void 0 ? void 0 : user.id)) {
        ...
        try {
            ...
            const { error } = yield supabase.from("strategy_actions").insert({
                ...
                user_id: user.id,
                action_type: "share",
                details: Object.assign({ shared_at: new Date().toISOString(), shared_by: user.email || "Unknown user" }, shareDetails),
            });
            if (error) {
    ...
    const trackStrategyUpdate = useCallback((strategyId, title, riskLevel) => __awaiter(this, void 0, void 0, function* () {
        if (!(user === null || user === void 0 ? void 0 : user.id)) {
