...
export function useProfileForm() {
    ...
    const { avatarUrl, setAvatarUrl, avatarFile, setAvatarFile, uploadAvatar } = useAvatarUpload();
    ...
    const onSubmit = (data) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const success = yield updateUserProfile(user.id, {
                name: data.name,
            ...
            if (avatarFile) {
                const uploadedAvatarUrl = yield uploadAvatar(user.id, avatarFile);
                if (uploadedAvatarUrl) {
                    // Update the avatar URL in the database
                    yield updateUserProfile(user.id, {
    ...
    const handleApiKeyChange = (key, value) => {
        setPersonalApiKeys((prev) => (Object.assign(Object.assign({}, prev), { [key]: value })));
    };
    return {
        isLoading,
        isDirty,
