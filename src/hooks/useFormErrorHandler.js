...
export function useFormErrorHandler(form, options = {}) {
    ...
    const handleServerValidationErrors = useCallback((errors) => {
        ...
        Object.entries(errors).forEach(([field, messages]) => {
            if (messages && messages.length > 0) {
                ...
                setServerErrors((prev) => (Object.assign(Object.assign({}, prev), { [field]: messages[0] })));
            }
        });
        if (logErrors) {
    ...
    const handleSubmissionError = useCallback((error) => {
        ...
        if (error.code === "VALIDATION_ERROR" && ((_a = error.context) === null || _a === void 0 ? void 0 : _a.fieldErrors)) {
        ...
        setServerErrors((prev) => (Object.assign(Object.assign({}, prev), { form: error.message || "An error occurred" })));
    ...
    const formatClientErrors = useCallback((errors) => {
        return Object.entries(errors).reduce((acc, [key, value]) => {
            ...
            const message = value === null || value === void 0 ? void 0 : value.message;
