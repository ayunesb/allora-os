import { SocialMediaPost, CreatePostInput, SocialMediaCalendarFilters } from '@/types/unified-types';
export declare const useSocialMedia: () => {
    ...
    updatePost: (postId: string, postData: Partial<SocialMediaPost>) => Promise<void>;
