 ...
 */
export declare function runLangChainAgent(params: AgentQuery): Promise<AgentResponse>;
/**
 * Execute a specific tool directly without running the full agent
 */
export declare function executeAgentTool(toolName: string, input: Record<string, any>): Promise<any>;
