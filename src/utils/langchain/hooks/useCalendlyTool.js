...
function useCalendlyTool() {
  ...
  var checkAvailability = function () {
    return __awaiter(_this, void 0, void 0, function () {
      var _a, data, error_1, err_1, message;
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            loggingService_1.logger.info("Checking Calendly availability");
            return [
              4 /*yield*/,
              client_1.supabase.functions.invoke("calendly-tool", {
          ...
          case 3:
            ...
            loggingService_1.logger.error(
              "Error checking Calendly availability",
              err_1,
            );
            setError(message);
            sonner_1.toast.error("Failed to check availability", {
              description: message,
            });
  ...
  var getMeetingTypes = function () {
    return __awaiter(_this, void 0, void 0, function () {
      var _a, data, error_2, err_2, message;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            setIsLoading(true);
          ...
          case 1:
            _b.trys.push([1, 3, 4, 5]);
            loggingService_1.logger.info("Getting Calendly meeting types");
            return [
              4 /*yield*/,
              client_1.supabase.functions.invoke("calendly-tool", {
          ...
          case 3:
            ...
            loggingService_1.logger.error(
              "Error getting Calendly meeting types",
              err_2,
            );
            setError(message);
            sonner_1.toast.error("Failed to get meeting types", {
              description: message,
            });
            return [2 /*return*/, null];
          case 4:
