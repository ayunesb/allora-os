...
export function useCalendlyTool() {
  ...
  const checkAvailability = async () => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Failed to check Calendly availability';
  ...
  const getMeetingTypes = async () => {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Failed to get Calendly meeting types';
