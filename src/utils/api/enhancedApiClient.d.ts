...
export declare const enhancedFetch: <T>(url: string, options?: EnhancedRequestConfig) => Promise<StandardResponse<T>>;
...
export declare function useProtectedApi<T, P = any>(apiFunction: (params: P) => Promise<T>, options?: UseProtectedApiOptions): {
    ...
    isLoading: boolean;
    error: Error;
    fetchApi: <T_1>(endpoint: string, method?: string, data?: any, additionalHeaders?: Record<string, string>) => Promise<T_1>;
};
