export type ApiErrorCode = 'NETWORK_ERROR' | 'TIMEOUT' | 'AUTHENTICATION_ERROR' | 'AUTHORIZATION_ERROR' | 'NOT_FOUND' | 'VALIDATION_ERROR' | 'SERVER_ERROR' | 'UNKNOWN_ERROR' | 'ACCESSIBILITY_ERROR';
 ...
 */
export declare function generateUserFriendlyMessage(error: ApiErrorDetails): string;
/**
 * Handle API errors with consistent logging and user feedback
 */
export declare function handleApiError(error: unknown, options?: ApiErrorOptions): ApiErrorDetails;
/**
