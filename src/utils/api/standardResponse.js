 ...
 */
function errorResponse(message, error, errorCode) {
  // Simpler error logging without depending on a logger
  if (error) {
    console.error("API Error: ".concat(message), {
      error: error,
      errorCode: errorCode,
    });
  }
 ...
 */
function safeExecute(fn_1) {
  return __awaiter(
    this,
    arguments,
    void 0,
    function (fn, successMessage, errorMessage) {
      var result, error_1, errorDetail;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            result = _a.sent();
            return [2 /*return*/, successResponse(result, successMessage)];
          case 2:
            error_1 = _a.sent();
            errorDetail =
              error_1 instanceof Error ? error_1.message : "Unknown error";
            return [2 /*return*/, errorResponse(errorMessage, errorDetail)];
          case 3:
            return [2 /*return*/];
        }
      });
