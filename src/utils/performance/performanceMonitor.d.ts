...
declare class PerformanceMonitor {
     ...
     */
    startMeasure(id: string, type?: 'page-load' | 'api-call' | 'render' | 'interaction' | 'custom', metadata?: Record<string, any>): string;
    /**
     ...
     */
    measureBetweenMarks(measureName: string, startMark: string, endMark: string): number | undefined;
    /**
