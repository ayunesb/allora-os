...
exports.getExecutiveImage = getExecutiveImage;
exports.getExecutiveSuggestions = getExecutiveSuggestions;
exports.generateRiskAssessment = generateRiskAssessment;
exports.generateRiskScenarios = generateRiskScenarios;
// Gets the appropriate image for an executive
function getExecutiveImage(executiveName) {
...
function getExecutiveSuggestions(riskAppetite) {
  ...
  switch (riskAppetite) {
    case "high":
      return __spreadArray(
        __spreadArray([], baseExecutives, true),
        [
          {
            id: "exec-3",
            name: "Elon Musk",
...
function generateRiskAssessment(businessData, riskAppetite) {
...
function generateRiskScenarios(industry) {
