 ...
 */
export declare function customizeTitle(
  baseTitle: string,
 ...
 */
export declare function customizeDescription(
 ...
 */
export declare function customizeROI(
  baseROI: string,
  companySize?: "Startup" | "Small" | "Medium" | "Enterprise",
): string;
/**
 ...
 */
export declare function customizeMetrics(
  baseMetrics: string[],
  industryContext?: string,
): string[];
