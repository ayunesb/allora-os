...
export declare function analyzeStrategyFactors(
...
export declare function calculateImplementationComplexity(
  strategy: GeneratedStrategy,
  assessmentInput: any,
): {
  score: number;
...
export declare function calculateCompetitiveAdvantage(
  strategy: GeneratedStrategy,
  riskProfile: any,
): {
  score: number;
...
export declare function estimateTimeToResults(
  strategy: GeneratedStrategy,
  riskProfile: any,
): {
  timeframe: string;
