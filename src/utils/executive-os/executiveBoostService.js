...
exports.determinePersonalityTraits = determinePersonalityTraits;
exports.determineCognitiveLayers = determineCognitiveLayers;
exports.determineMentalModels = determineMentalModels;
exports.generateDailyMission = generateDailyMission;
 ...
 */
function determinePersonalityTraits(name, role) {
 ...
 */
function determineCognitiveLayers(role) {
  var roleLower = role.toLowerCase();
 ...
 */
function determineMentalModels(role) {
  var roleLower = role.toLowerCase();
  var mentalModels = [];
  ...
  mentalModels.push({
    ...
    description:
      "Breaking down complex problems into basic elements and reassembling from the ground up",
  });
  mentalModels.push({
    name: "Inversion",
    description:
      "Approaching problems backward, focusing on eliminating what doesn't work",
  });
  ...
  if (roleLower.includes("ceo")) {
    mentalModels.push(
      {
        name: "10x Thinking",
        description:
          "Seeking massive, transformative improvements rather than incremental ones",
      },
      {
        name: "Regret Minimization",
        description:
          "Making decisions based on minimizing regret in the long-term future",
      },
    );
  } else if (roleLower.includes("cfo")) {
    mentalModels.push(
      {
        ...
        description:
          "Allowing for a cushion to account for uncertain outcomes and risks",
      },
      {
        name: "Circle of Competence",
        description:
          "Focusing on areas where you have expertise and avoiding those you don't",
      },
    );
  } else if (roleLower.includes("cto") || roleLower.includes("cio")) {
    mentalModels.push(
      {
        ...
        description:
          "Analyzing how parts of a system interact and affect the whole",
      },
      {
        name: "Exponential Growth Law",
        description:
          "Understanding how technologies improve at an exponential rather than linear rate",
      },
    );
  } else if (roleLower.includes("cmo")) {
    mentalModels.push(
      {
        name: "StoryBrand",
        description:
          "Positioning the customer as the hero and your brand as the guide",
      },
      {
    ...
    mentalModels.push(
      {
        ...
        description:
          "Understanding what job customers are hiring your product to do",
      },
      {
        name: "Disruption Theory",
        description:
          "Identifying how smaller companies can disrupt established ones",
      },
    );
    ...
    mentalModels.push(
      ...
      },
      {
        name: "MVP Model",
        description:
          "Building the minimum viable product to test assumptions with real users",
      },
    );
    ...
    mentalModels.push(
      {
        ...
        description:
          "Understanding behavior as a function of motivation, ability, and triggers",
      },
      {
        name: "UX Heuristics",
        description:
          "Applying recognized usability principles to design decisions",
      },
    );
    ...
    mentalModels.push(
      {
        ...
        description:
          "Updating probability estimates as new information becomes available",
      },
      {
        name: "Compounding Effects",
        description:
          "Understanding how small changes can lead to significant results over time",
      },
    );
  }
    ...
    mentalModels.push(
      {
        ...
        description:
          "Considering what you give up when making one choice over another",
      },
      {
 ...
 */
function generateDailyMission(role, companyGoals) {
  var roleLower = role.toLowerCase();
  ...
  var mission = {
    ...
    riskReward: {
      description:
        "Assessment of the risk and potential reward of today's mission",
      level: "medium",
      riskFactors: [],
      rewardPotential: [],
    },
  ...
  if (roleLower.includes("ceo")) {
    mission.northStar =
      "Drive company vision and maximize long-term value creation";
  } else if (roleLower.includes("cfo")) {
    mission.northStar =
      "Optimize financial performance and ensure sustainable growth";
  } else if (roleLower.includes("cto") || roleLower.includes("cio")) {
    ...
    mission.northStar =
      "Create a high-performing organization through talent and culture";
  } else if (roleLower.includes("strategy")) {
    mission.northStar =
      "Identify growth opportunities and optimize competitive positioning";
  } else if (roleLower.includes("product")) {
    mission.northStar =
      "Deliver products that create exceptional value for customers";
  } else {
    mission.northStar =
      "Drive excellence in your domain to support company goals";
  }
  // Set role-specific moves
  if (roleLower.includes("ceo")) {
    mission.moves.innovation =
      "Explore a potential strategic pivot or new business model";
    mission.moves.execution =
      "Align executive team around top quarterly priorities";
    mission.moves.customer =
      "Connect with key customers to understand evolving needs";
  } else if (roleLower.includes("cfo")) {
    mission.moves.innovation =
      "Identify a new approach to optimize cash flow or reduce costs";
    mission.moves.execution =
      "Ensure financial reports provide actionable insights";
    mission.moves.customer =
      "Evaluate pricing strategy based on customer value perception";
  } else if (roleLower.includes("cto") || roleLower.includes("cio")) {
    mission.moves.innovation =
      "Evaluate an emerging technology that could transform operations";
    ...
    mission.moves.innovation =
      "Test a new marketing channel or creative approach";
    mission.moves.execution =
      "Optimize performance of current marketing campaigns";
    mission.moves.customer = "Analyze customer journey for friction points";
  } else if (roleLower.includes("chro")) {
    mission.moves.innovation =
      "Pilot a new approach to talent development or engagement";
    mission.moves.execution =
      "Ensure talent alignment with strategic priorities";
    mission.moves.customer = "Gather feedback on employee experience";
  } else if (roleLower.includes("strategy")) {
    mission.moves.innovation =
      "Identify an underserved market segment or new offering";
    mission.moves.execution = "Track progress on strategic initiatives";
    mission.moves.customer =
      "Analyze changing customer needs and competitive landscape";
  } else {
    mission.moves.innovation =
      "Explore a new approach or method in your domain";
    mission.moves.execution = "Optimize current processes for better results";
    mission.moves.customer =
      "Gather feedback from internal or external customers";
  }
