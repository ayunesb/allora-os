...
// Custom cognitive boosts for each executive
...
// Additional mental models for specific executives
...
export const ceoCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Elon Musk': {
    name: 'Moonshot thinking',
    description: 'Targeting 10x improvements rather than incremental gains',
    application: 'Applied to breakthrough innovation and market disruption strategies'
  },
  'Jeff Bezos': {
    name: 'Operational scaling',
    description: 'Systematic approach to scaling operations while maintaining quality',
    application: 'Used for rapid growth while ensuring operational excellence'
  },
  'Satya Nadella': {
    name: 'Adaptive leadership',
    description: 'Constantly evolving leadership approach based on changing conditions',
    application: 'Especially effective during digital transformation initiatives'
  },
  'Tim Cook': {
    name: 'Execution excellence',
    description: 'Relentless focus on operational detail and perfect execution',
    application: 'Applied to supply chain optimization and product quality assurance'
  }
};

// CFO Cognitive Boosts
export const cfoCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Warren Buffett': {
    name: 'Risk management',
    description: 'Sophisticated approach to evaluating and mitigating financial risk',
    application: 'Investment decisions and capital allocation strategies'
  }
};

// CIO/CTO Cognitive Boosts
export const techCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Steve Jobs': {
...
export const cmoCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Antonio Lucio': {
  ...
  'Keith Weed': {
    ...
    description: 'Integrating environmental and social responsibility into business',
    application: 'Creating sustainable marketing strategies and brand positioning'
  }
};

// Sales Cognitive Boosts
export const salesCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Trish Bertuzzi': {
    name: 'Sales playbook',
    description: 'Systematic approach to sales process optimization',
    application: 'Creating scalable sales methodologies and enablement programs'
  },
  'Mike Weinberg': {
    name: 'Pipeline focus',
...
export const cooCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Sheryl Sandberg': {
    name: 'Team builder',
  ...
  'Gwynne Shotwell': {
    ...
    application: 'Tackling complex operational challenges with innovative approaches'
  }
};

// Strategy Cognitive Boosts
export const strategyCognitiveBoosts: Record<string, CognitiveBoost> = {
  'Clayton Christensen': {
...
export const additionalMentalModels: Record<string, MentalModel> = {
  'tenXThinking': {
    name: '10x vs. 10% Thinking',
    description: 'Focusing on order-of-magnitude improvements rather than incremental gains',
  ...
  'okrs': {
    ...
    description: 'Framework for setting challenging, ambitious goals with measurable results',
    application: 'Goal setting and performance management'
  },
  'circleOfCompetence': {
    name: 'Circle of Competence',
    description: 'Focusing on areas where you have genuine knowledge and expertise',
    application: 'Strategic decision-making and resource allocation'
  },
  'realityDistortionField': {
    name: 'Reality Distortion Field',
    description: 'Creating a compelling vision that motivates people to achieve the seemingly impossible',
  ...
  'tripleBottomLine': {
    ...
    description: 'Measuring success by social, environmental, and financial performance',
  ...
  'huntingFarming': {
    ...
    description: 'Balance between acquiring new customers and growing existing accounts',
  ...
  'criticalPathMethod': {
    ...
    description: 'Identifying the sequence of crucial tasks that determine project duration',
    application: 'Project management and operational planning'
  },
  'jobsToBeDone': {
    name: 'Jobs to Be Done (JTBD)',
    description: 'Understanding the "job" customers are hiring your product to do',
  ...
  'buildMeasureLearn': {
    ...
    description: 'Iterative process for testing ideas and improving based on feedback',
  ...
  'bimodalIT': {
    ...
    description: 'Two-track IT approach: one focused on stability, one on agility',
  ...
  'netPromoterSystem': {
    ...
    description: 'Measurement of customer loyalty and predictor of business growth',
  ...
  'selfSupervisedLearning': {
    ...
    description: 'Machine learning approach that uses unlabeled data to train models',
  ...
  '360FeedbackLoops': {
    ...
    description: 'Multi-source feedback system for comprehensive performance assessment',
    application: 'Leadership development and performance management'
  },
  'centerOfExcellenceModel': {
    name: 'Center of Excellence Model',
    description: 'Dedicated unit focusing on specific capability or business practice',
  ...
  'networkEffects': {
    ...
    description: 'Value of a product or service increases with the number of users',
    application: 'Platform strategy and growth planning'
  }
};

// Map executives to their personalized cognitive boosts and mental models
export const executiveEnhancements: Record<string, {boost: CognitiveBoost, model: MentalModel}> = {
  'Elon Musk': {
    boost: ceoCognitiveBoosts['Elon Musk'],
    model: additionalMentalModels['tenXThinking']
  },
  'Jeff Bezos': {
    boost: ceoCognitiveBoosts['Jeff Bezos'],
    model: additionalMentalModels['flywheelEffect']
  },
  'Satya Nadella': {
    boost: ceoCognitiveBoosts['Satya Nadella'],
    model: additionalMentalModels['growthMindset']
  },
  'Tim Cook': {
    boost: ceoCognitiveBoosts['Tim Cook'],
    model: additionalMentalModels['okrs']
  },
  'Warren Buffett': {
    boost: cfoCognitiveBoosts['Warren Buffett'],
    model: additionalMentalModels['circleOfCompetence']
  },
  'Steve Jobs': {
    boost: techCognitiveBoosts['Steve Jobs'],
    model: additionalMentalModels['realityDistortionField']
  },
  'Antonio Lucio': {
    boost: cmoCognitiveBoosts['Antonio Lucio'],
    model: additionalMentalModels['storyBrandFramework']
  },
  'Keith Weed': {
    boost: cmoCognitiveBoosts['Keith Weed'],
    model: additionalMentalModels['tripleBottomLine']
  },
  'Trish Bertuzzi': {
    boost: salesCognitiveBoosts['Trish Bertuzzi'],
    model: additionalMentalModels['meddic']
  },
  'Mike Weinberg': {
    boost: salesCognitiveBoosts['Mike Weinberg'],
    model: additionalMentalModels['huntingFarming']
  },
  'Sheryl Sandberg': {
    boost: cooCognitiveBoosts['Sheryl Sandberg'],
    model: additionalMentalModels['servantLeadership']
  },
  'Gwynne Shotwell': {
    boost: cooCognitiveBoosts['Gwynne Shotwell'],
    model: additionalMentalModels['criticalPathMethod']
  },
  'Clayton Christensen': {
    boost: strategyCognitiveBoosts['Clayton Christensen'],
    model: additionalMentalModels['jobsToBeDone']
  },
  'Brian Chesky': {
    boost: strategyCognitiveBoosts['Brian Chesky'],
    model: additionalMentalModels['designThinking']
  },
  'Reed Hastings': {
    boost: strategyCognitiveBoosts['Reed Hastings'],
    model: additionalMentalModels['buildMeasureLearn']
  }
};

// Default enhancements for executives not explicitly mapped
export const getExecutiveEnhancements = (executiveName: string) => {
  if (executiveEnhancements[executiveName]) {
    return executiveEnhancements[executiveName];
  }
