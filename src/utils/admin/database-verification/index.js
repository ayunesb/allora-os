...
__exportStar(require("./tableVerification"), exports);
__exportStar(require("./rlsVerification"), exports);
__exportStar(require("./functionVerification"), exports);
__exportStar(require("./displayResults"), exports);
// Add a new dedicated function to check if a user is logged in and has admin privileges
function checkVerificationAccess() {
  return __awaiter(this, void 0, void 0, function () {
    var supabase, session, _a, profile, profileError, error_1;
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          return [2 /*return*/, { canAccess: true }];
        case 4:
          error_1 = _b.sent();
          console.error("Error checking verification access:", error_1);
          return [
            2 /*return*/,
            {
              canAccess: false,
