...
export async function getUserPreferences(
  ...
  try {
    ...
    return {
      responseStyle:
        (data.communication_style as "concise" | "balanced" | "detailed") ||
      ...
      modelPreference:
        dashboardPrefs.modelPreference || defaultPreferences.modelPreference,
      enableDebate:
      ...
      enableLearning:
        dashboardPrefs.enableLearning || defaultPreferences.enableLearning,
    };
  } catch (error) {
