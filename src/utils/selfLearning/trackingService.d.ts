 ...
 */
export declare function trackUserAction(
  userId: string,
  action: string,
  category: string,
  entityId: string,
 ...
 */
export declare function trackStrategyFeedback(
  userId: string,
  strategyId: string,
  isPositive: boolean,
  metadata?: Record<string, any>,
 ...
 */
export declare function trackCampaignFeedback(
  userId: string,
  campaignId: string,
  isPositive: boolean,
  metadata?: Record<string, any>,
 ...
 */
export declare function trackScriptFeedback(
  userId: string,
  scriptId: string,
