...
exports.getLearningInsights = getLearningInsights;
var getUserPreferences_1 = require("../preferences/getUserPreferences");
var insightUtils_1 = require("./insightUtils");
/**
 * Get user learning insights based on their interaction history
 */
function getLearningInsights(userId) {
  return __awaiter(this, void 0, void 0, function () {
    var preferences, insights, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          insights = [
            ...
            },
            {
              ...
              value:
                (0, insightUtils_1.calculateLearningProgress)(preferences) +
                "/10",
              description: "How well we understand your preferences",
            },
            {
              title: "Focus Area",
              value: (0, insightUtils_1.getFocusArea)(preferences),
        ...
        case 2:
          error_1 = _a.sent();
          console.error("Error generating learning insights:", error_1);
          return [
            2 /*return*/,
            [
              {
