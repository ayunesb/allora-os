...
__exportStar(require("./urlValidators"), exports);
__exportStar(require("./contentValidators"), exports);
var schema_1 = require("./schema");
var urlValidators_1 = require("./urlValidators");
/**
 * Validates a social media post with additional platform-specific logic
 */
function validateSocialMediaPost(post) {
  return __awaiter(this, void 0, void 0, function () {
    var schemaValidation;
    return __generator(this, function (_a) {
      schemaValidation = schema_1.socialMediaPostSchema.safeParse(post);
      ...
      if (post.content_type === "image" || post.content_type === "video") {
        if (!post.media_urls || post.media_urls.length === 0) {
          return [
            ...
            {
              valid: false,
              message: "Posts with content type '".concat(
                post.content_type,
        ...
        if (!(0, urlValidators_1.validateMediaUrls)(post.media_urls)) {
          return [
            2 /*return*/,
            {
              valid: false,
