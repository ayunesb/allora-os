...
import { validateSocialMediaPost, validateContentLength, validateHashtags, validateMediaUrls, socialMediaPostSchema, } from "../socialMediaValidator";
...
describe("socialMediaValidator", () => {
    ...
    describe("validateMediaUrls", () => {
        ...
        it("invalidates incorrect URLs", () => {
            expect(validateMediaUrls(["not-a-url", "ftp://invalid-protocol.com/file.txt"])).toBe(false);
        });
        it("handles non-array inputs", () => {
            expect(validateMediaUrls("not an array")).toBe(false);
        });
    });
    ...
    describe("validateSocialMediaPost", () => {
        it("validates a valid post", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield validateSocialMediaPost({
                title: "Valid Post",
        ...
        it("invalidates posts with missing required fields", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield validateSocialMediaPost({
        ...
        it("validates media requirements based on content type", () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield validateSocialMediaPost({
                title: "Image Post",
