 ...
 */
function createTestCompany(userId, userEmail) {
  return __awaiter(this, void 0, void 0, function () {
    var emailPrefix, companyName, _a, data, error, error_1;
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          _b.trys.push([0, 2, , 3]);
          emailPrefix = userEmail.split("@")[0];
          companyName = "Test Company - ".concat(emailPrefix);
          return [
            4 /*yield*/,
            supabase_1.supabase
              .from("companies")
        ...
        case 1:
          ...
          if (error) {
            return [
              ...
              {
                success: false,
                message: "Failed to create test company: ".concat(
                  error.message,
                ),
        ...
        case 2:
          ...
          return [
            ...
            {
              success: false,
              message: "Error creating test company: ".concat(error_1.message),
