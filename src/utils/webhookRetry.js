 ...
 */
export const executeWebhook = (url, payload, type, eventType) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
export const executeWithRetry = (url_1, payload_1, type_1, eventType_1, ...args_1) => __awaiter(void 0, [url_1, payload_1, type_1, eventType_1, ...args_1], void 0, function* (url, payload, type, eventType, options = {}) {
    ...
    try {
        while (attempt <= maxRetries) {
            try {
                ...
                const result = yield executeWebhook(url, payload, type, eventType);
    ...
    return {
        success: false,
        message: (lastError === null || lastError === void 0 ? void 0 : lastError.message) || "Maximum retries exceeded",
        error: lastError,
    };
});
