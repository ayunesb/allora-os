...
exports.translations = {
  en: {
    digitalTwin: {
      ...
      description:
        "3D visualization of your company's key performance indicators",
  ...
  es: {
    digitalTwin: {
      ...
      description:
        "Visualización 3D de los indicadores clave de rendimiento de su empresa",
      loading: "Cargando Gemelo Digital...",
      tooltip:
        "Pase el cursor sobre las esferas para ver información detallada del KPI. Arrastre para rotar, desplácese para hacer zoom.",
  ...
  fr: {
    digitalTwin: {
      ...
      description:
        "Visualisation 3D des indicateurs clés de performance de votre entreprise",
      loading: "Chargement du Jumeau Numérique...",
      tooltip:
        "Survolez les sphères pour voir les informations détaillées des KPI. Faites glisser pour pivoter, défilez pour zoomer.",
      refresh: "Actualiser les données",
      refreshing: "Actualisation...",
      refreshSuccess: "Données actualisées avec succès",
      refreshDescription: "Les dernières données KPI ont été chargées",
      performanceTip:
        "Un FPS plus élevé signifie une visualisation plus fluide",
      visualizationTitle: "Visualisation des KPI en temps réel",
    },
  },
};
function getTranslation(language) {
  return exports.translations[language] || exports.translations.en;
}
