import { botSpecialSkills as importedBotSpecialSkills, botOutputLocations as importedBotOutputLocations, botExampleActions as importedBotExampleActions, } from "@/constants/botSkills";
...
export const getBotExpertise = (role) => {
...
export const getBotOutputLocation = (role) => {
...
export const getBotExampleAction = (role) => {
