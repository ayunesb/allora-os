...
exports.getBotExampleAction =
  exports.getBotOutputLocation =
  exports.getBotExpertise =
  exports.formatRoleTitle =
    void 0;
var botSkills_1 = require("@/constants/botSkills");
...
var formatRoleTitle = function (role) {
  switch (role) {
    // C-Suite
    case "ceo":
...
exports.formatRoleTitle = formatRoleTitle;
var getBotExpertise = function (role) {
  // Use the specialized skills if available
  if (botSkills_1.botSpecialSkills && botSkills_1.botSpecialSkills[role]) {
    return Array.isArray(botSkills_1.botSpecialSkills[role])
      ? botSkills_1.botSpecialSkills[role].join(", ")
      : botSkills_1.botSpecialSkills[role];
  }
...
exports.getBotExpertise = getBotExpertise;
var getBotOutputLocation = function (role) {
  if (botSkills_1.botOutputLocations && botSkills_1.botOutputLocations[role]) {
    return Array.isArray(botSkills_1.botOutputLocations[role])
      ? botSkills_1.botOutputLocations[role].join(", ")
      : botSkills_1.botOutputLocations[role];
  }
...
exports.getBotOutputLocation = getBotOutputLocation;
var getBotExampleAction = function (role) {
  if (botSkills_1.botExampleActions && botSkills_1.botExampleActions[role]) {
    return Array.isArray(botSkills_1.botExampleActions[role])
      ? botSkills_1.botExampleActions[role].join(", ")
      : botSkills_1.botExampleActions[role];
  }
...
exports.getBotExampleAction = getBotExampleAction;
