...
export declare function fetchCompetitorBenchmarks(
  strategyId: string,
): Promise<CompetitorBenchmark[]>;
export declare function createCompetitorBenchmark(
  benchmark: Omit<CompetitorBenchmark, "id" | "created_at">,
): Promise<CompetitorBenchmark | null>;
export declare function updateCompetitorBenchmark(
  id: string,
...
export declare function calculateMarketPosition(
