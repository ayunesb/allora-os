 ...
 */
export declare function validateAndSanitize<T>(schema: z.ZodType<T>, data: unknown): {
    success: boolean;
    data?: T;
...
export declare const phoneSchema: z.ZodUnion<[z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>, z.ZodLiteral<"">]>;
 ...
 */
export declare function withCsrfProtection<T extends z.ZodRawShape>(schema: z.ZodObject<T>): z.ZodObject<z.objectUtil.extendShape<T, {
