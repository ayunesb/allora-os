 ...
 */
export declare function logError(error: unknown, context: string, additionalData?: any): void;
/**
 * Log application warnings
 */
export declare function logWarning(message: string, context: string, data?: any): void;
/**
 * Log performance information
 */
export declare function logPerformance(operation: string, timeInMs: number): void;
/**
