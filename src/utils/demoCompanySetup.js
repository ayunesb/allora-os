 ...
 */
export async function createDemoCompany(userId, options = {}) {
    try {
 ...
 */
async function generateDemoContent(userId, companyId, settings) {
    try {
 ...
 */
async function createSampleLeads(companyId) {
    const demoLeads = [
        {
            name: 'John Smith',
 ...
 */
export async function convertDemoToPublicCaseStudy(companyId) {
    try {
