...
export function logError(error, metadata = {}) {
    try {
        ...
        const errorInfo = Object.assign(Object.assign({ name: errorObject.name, message: errorObject.message, stack: errorObject.stack }, metadata), { timestamp: new Date().toISOString(), url: window.location.href, userAgent: navigator.userAgent });
