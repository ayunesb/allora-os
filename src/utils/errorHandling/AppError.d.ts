...
export declare class ApplicationError implements AppError {
    ...
    source?: string;
    isCritical: boolean;
    constructor({ message, code, data, source, isCritical }: {
        message: string;
        code?: string;
        data?: any;
        source?: string;
 ...
 */
export declare function createAppError(message: string, code?: string, data?: any, source?: string, isCritical?: boolean): AppError;
