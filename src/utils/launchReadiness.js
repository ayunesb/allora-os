    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                ...
                const { error: boardroomTableError } = yield supabase
                ...
                for (const table of tables) {
                    const { error: tableError } = yield supabase
                        .from(table)
                        .select("id", { head: true })
                        .limit(1);
                    if (tableError) {
            ...
            return Object.assign(Object.assign({}, status), { overallStatus: "not_ready", database: {
                    status: "error",
