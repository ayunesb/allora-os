...
function verifyZapierWebhooks() {
  return __awaiter(this, void 0, void 0, function () {
    var webhookTypes, results, _i, _a, _b, type, webhook, payload;
    return __generator(this, function (_c) {
      ...
      for (_i = 0, _a = Object.entries(webhookTypes); _i < _a.length; _i++) {
        (_b = _a[_i]), (type = _b[0]), (webhook = _b[1]);
        if (!webhook) {
          results[type] = false;
          continue;
        }
        try {
          ...
          console.error("Error testing ".concat(type, " webhook:"), error);
          results[type] = false;
        }
      }
