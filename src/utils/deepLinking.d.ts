 ...
 */
export declare const createDeepLink: (basePath: string, params?: DeepLinkParams, hash?: string) => string;
/**
 ...
 */
export declare const createShareableLink: (route: string, state: Record<string, any>) => string;
/**
 ...
 */
export declare const extractDeepLinkParams: <T extends Record<string, any>>(searchParams: URLSearchParams, paramMap: Record<string, "string" | "number" | "boolean">) => Partial<T>;
/**
 ...
 */
export declare const createViewDeepLinker: (baseRoute: string) => (params?: DeepLinkParams, hash?: string) => string;
export {};
