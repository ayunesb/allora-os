...
declare class MonitoringSystem {
    ...
    setGauge(name: string, value: number, min?: number, max?: number, unit?: string, thresholds?: {
        warning: number;
        critical: number;
    }): void;
...
export declare function reportInfo(title: string, message: string, metadata?: Record<string, any>): Alert;
export declare function reportWarning(title: string, message: string, metadata?: Record<string, any>): Alert;
export declare function reportError(title: string, message: string, metadata?: Record<string, any>): Alert;
export declare function reportCritical(title: string, message: string, metadata?: Record<string, any>): Alert;
export {};
