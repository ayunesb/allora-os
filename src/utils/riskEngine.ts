...
export type RiskAssessmentInput = {
  ...
  marketVolatility?: number; // 1-5
  competitionIntensity?: number; // 1-5
  organizationalReadiness?: number; // 1-5
  innovationCapacity?: number; // 1-5
  regulatoryConstraints?: number; // 1-5
