 ...
 */
export declare function sendSlackAlert(message: string, severity?: 'info' | 'warning' | 'error'): Promise<boolean>;
/**
 ...
 */
export declare function withSlackErrorReporting<T>(operation: () => Promise<T>, errorMessage?: string): Promise<T>;
