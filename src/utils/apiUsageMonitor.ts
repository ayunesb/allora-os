 ...
 */
export async function getApiUsage(companyId: string): Promise<ApiUsageMetrics | null> {
  try {
 ...
 */
async function checkUsageLimits(companyId: string, currentUsage: any): Promise<void> {
  try {
 ...
 */
async function suggestUpgrade(companyId: string, currentTier: string): Promise<void> {
  try {
    // Get next tier
