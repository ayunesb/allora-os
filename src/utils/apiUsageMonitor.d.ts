 ...
 */
export declare function recordApiUsage(companyId: string, usageType: keyof Omit<ApiUsageMetrics, 'lastUpdated' | 'totalApiCalls'>, amount?: number): Promise<boolean>;
/**
 * Gets API usage for a specific company
 */
export declare function getApiUsage(companyId: string): Promise<ApiUsageMetrics | null>;
/**
