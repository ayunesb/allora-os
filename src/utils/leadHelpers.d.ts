 ...
 */
export declare function updateLeadStatus(leadId: string, status: LeadStatus): Promise<boolean>;
/**
 * Delete a lead
 */
 ...
 * Create a new lead
 */
export declare function createLead(leadData: Omit<Lead, 'id' | 'created_at'>): Promise<Lead | null>;
