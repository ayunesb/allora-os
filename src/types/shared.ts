 ...
 */
export type Status = 'draft' | 'active' | 'paused' | 'completed' | 'cancelled' | 'pending' | 'scheduled';
 ...
 */
export type SocialPlatform = 'Facebook' | 'Instagram' | 'Twitter' | 'LinkedIn' | 'TikTok' | 'Google' | 'Email' | 'YouTube' | 'Pinterest';
