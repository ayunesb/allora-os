        ...
        <div className="flex flex-col space-y-6">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">
              AI Executive Upgrades
            </h1>
            <p className="text-muted-foreground mt-1">
              Upgrade your AI executives with the Allora Executive OS and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <UpgradeAllExecutives
                onUpgradeComplete={handleBulkUpgradeComplete}
              />

              <div className="border border-border rounded-lg p-4">
                <h3 className="text-lg font-medium mb-2">
                  Executive OS Features
                </h3>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="bg-primary/10 text-primary rounded-full h-5 w-5 flex items-center justify-center mt-0.5 shrink-0">
                      1
                    </div>
