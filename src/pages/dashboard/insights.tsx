...
export default function InsightsPage() {
  ...
  const { data: kpiData, isLoading: isKpiLoading, error: kpiError } = useApiQuery<{
    total_wins: number;
    total_strategies: number;
    total_users: number;
  }>('/api/kpi', { timeframe });

  const { data: chartData, isLoading: isChartLoading, error: chartError } = useApiQuery<DataItem[]>('/api/chart', { timeframe });
