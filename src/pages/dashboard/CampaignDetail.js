...
export default function CampaignDetail() {
    ...
    return (<div className="container mx-auto px-4 py-12">
      ...
      <CampaignDetailHeader campaign={campaign} onBack={() => navigate('/dashboard/campaigns')} onDeploy={handleDeployCampaign} isDeploying={isDeploying}/>
      
      {/* Metric cards */}
      <CampaignMetricCards campaign={campaign}/>
      
      {/* Campaign metrics section when deployed */}
      {campaign.payment_status === 'paid' && campaign.deployment_status === 'deployed' && (<Card className="mb-8">
          <CardContent className="pt-6">
            <CampaignMetrics campaign={campaign} onRefresh={handleRefreshData} isRefreshing={isRefreshing}/>
          </CardContent>
        </Card>)}
