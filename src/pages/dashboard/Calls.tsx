...
const Calls = () => {
    ...
    return (<div className="container mx-auto p-4">
      <PageTitle title="Communication Scripts" description="AI-generated scripts for your sales calls, follow-ups, and customer engagement"/>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Button onClick={onGenerateScript} disabled={isFetching} className="col-span-1">
            ...
            <Tabs defaultValue="all">
              ...
              <TabsContent value="all" className="space-y-4">
                {isLoading ? (<div className="space-y-4">
                    ...
                    <Skeleton className="h-24 w-full"/>
                  </div>) : scripts.length > 0 ? (scripts.map(script => (<div key={script.id} className="p-4 border rounded-md">
              ...
              <TabsContent value="sales" className="space-y-4">
                {isLoading ? (<Skeleton className="h-24 w-full"/>) : scripts.filter(s => s.script_type === 'sales').length > 0 ? (scripts
            .filter(s => s.script_type === 'sales')
            .map(script => (<div key={script.id} className="p-4 border rounded-md">
                        <div className="flex justify-between items-start mb-2">
              ...
              <TabsContent value="followup" className="space-y-4">
                {isLoading ? (<Skeleton className="h-24 w-full"/>) : scripts.filter(s => s.script_type === 'followup').length > 0 ? (scripts
