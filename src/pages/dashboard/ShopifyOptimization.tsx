        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent>
            <p className="mb-6 text-gray-500">
              Connect your Shopify store to get personalized optimization
              recommendations, automated improvements, and detailed analytics to
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-400">
                By connecting your store, you'll grant us read and write access
                to optimize your store. You can revoke access at any time from
