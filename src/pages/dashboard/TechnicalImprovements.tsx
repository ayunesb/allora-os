        ...
        <Tabs defaultValue="performance" value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm">API Key Security</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button variant="outline" className="w-full">
                        Manage API Keys
          ...
          <TabsContent value="api" className="space-y-4 mt-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-purple-600">{apiMetrics.endpoints}</div>
                  <div className="text-xs text-muted-foreground mt-1">
                    {apiMetrics.endpoints > 20 ? 'Extensive API coverage' : 'Basic API coverage'}
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-cyan-600">{apiMetrics.webhookIntegrations}</div>
                  <div className="text-xs text-muted-foreground mt-1">
                    {apiMetrics.webhookIntegrations > 0 ? 'Active integrations' : 'No integrations'}
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm">Communication Analysis</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button variant="outline" className="w-full">
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm">Feedback Analysis</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button variant="outline" className="w-full">
                        Analyze Feedback
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm">Sentiment Reports</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button variant="outline" className="w-full">
                        View Reports
          ...
          <TabsContent value="knowledge" className="space-y-4 mt-4">
            ...
            <Card>
              ...
              <CardContent>
                <Button className="w-full">Request Industry Knowledge Base</Button>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
