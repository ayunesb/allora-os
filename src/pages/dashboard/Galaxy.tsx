...
export default function GalaxyPage() {
  ...
  const [hoveredNodeData, setHoveredNodeData] = useState<any | null>(null); // Store hovered node data
    ...
    <div className="p-6 flex">
      <div className="flex-1">
        ...
        <GalaxyGraph
          ...
          nodeColor={(node: any) => (node.type === 'plugin' ? '#6366f1' : '#22d3ee')}
          nodeVal={(node: any) => node.xp || 1} // XP influences node size
          ...
          linkWidth={(link: any) => link.impact || 1}
          linkColor={(link: any) => (link.type === 'plugin-strategy' ? '#7dd3fc' : '#f472b6')}
      ...
      >
        {hoveredNodeData && hoveredNodeData.type === 'strategy' && (
          <AgentVotePanel
            ...
            renderVersionBadge={(version: string) => (
