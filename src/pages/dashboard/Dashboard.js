...
export default function Dashboard() {
    ...
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleRefreshData} variant="outline" size="sm" disabled={isRefreshing} className="flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
        <div className="md:col-span-2">
          <CeoMessage riskAppetite={normalizedUser?.risk_appetite || 'medium'}/>
        </div>
        <div>
          <Card>
      ...
      {data && <AiRecommendations recommendations={data.recommendations || []} onApprove={(index) => {
