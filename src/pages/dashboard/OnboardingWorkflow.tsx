          ...
          <CardHeader className="pb-4">
            <div className="flex flex-col items-center text-center mb-4">
              ...
              <CardTitle className="text-2xl">
                AI Executive Workflow Generated!
              </CardTitle>
              <CardDescription className="text-lg">
                Your AI executive team has created strategies, campaigns, and
                scripts based on your company profile.
              </CardDescription>
            </div>
          </CardHeader>
    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Get personalized business strategies, marketing campaigns, and
          communication scripts from your AI executive team
        </p>
      </div>
        ...
        <TabsContent value="profile" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide information about your company to generate personalized
