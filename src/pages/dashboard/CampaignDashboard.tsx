...
export default function CampaignDashboard() {
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      <CampaignHeader onRefresh={handleRefreshData} onCreateCampaign={handleCreateCampaign} isRefreshing={isRefreshing}/>
      ...
      <CampaignList campaigns={campaigns} filteredCampaigns={filteredCampaigns} onCreateCampaign={handleCreateCampaign}/>
    </div>);
}
