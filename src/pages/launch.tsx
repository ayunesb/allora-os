...
export default function LaunchPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-b from-background via-black/60 to-background text-white px-6 py-12 flex flex-col items-center">
      ...
      <div className="aspect-video w-full max-w-3xl rounded-xl overflow-hidden shadow-xl mb-6">
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/YOUR_VIDEO_ID_HERE" title="Allora OS Launch Video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>

      <div className="mb-6 text-left space-y-2 w-full max-w-md">
        {features.map((f) => (<div key={f} className="flex items-center gap-2 text-sm text-muted-foreground">
      ...
      {user && stats && (<div className="mt-8 w-full max-w-2xl border border-white/10 bg-white/5 rounded-xl p-6 space-y-4">
      ...
      <div className="mt-10">
        <script async defer src="https://buttons.github.io/buttons.tsx"></script>
        <iframe src="https://www.producthunt.com/widgets/embed.tsx" width="100%" height="70" style={{ border: 'none', overflow: 'hidden' }} title="Product Hunt Widget"></iframe>
      </div>
