...
export default function LegalDocument() {
    ...
    return (_jsx("div", { className: "container mx-auto py-8 px-4", children: _jsx(DocumentLegalContent, { title: documentContent.title, description: documentContent.description, content: documentContent.content }) }));
}
