          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-3 border rounded">
                <h3 className="font-medium mb-2">Fix ComplianceProvider Issue</h3>
                <p className="text-sm text-muted-foreground mb-3">
                  The Legal Document component needs to be properly wrapped with ComplianceProvider.
                  This fix will modify LegalDocument.tsx to ensure proper context is provided.
                </p>
      ...
      <DocumentLegalContent />
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  Try accessing the <Link to="/admin" className="underline">Admin Dashboard</Link> directly.
                </AlertDescription>
              </Alert>
            </div>
          </CardContent>
