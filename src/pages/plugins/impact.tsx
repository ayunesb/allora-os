...
import { calculateImpact } from "@/utils/impactUtils";
  ...
  return (
    <div className="container py-8">
      ...
      <p className="text-muted-foreground mb-8">
        Track the impact and return on investment for all activated plugins
          ...
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              <p className="mb-2 font-medium">
                No plugin impact data available
              </p>
              <p className="text-sm">
              ...
              <Table>
                ...
                <TableBody>
                  {impactData.map((item, idx) => (
                    <TableRow
                      key={`${item.tenant_id}-${item.plugin_name}-${idx}`}
                    >
                      ...
                      <TableCell>
                        {item.tenant_name ||
                          `Tenant ${item.tenant_id.substring(0, 6)}...`}
                      </TableCell>
