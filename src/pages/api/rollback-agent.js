      ...
      switch (_c.label) {
        case 0:
          ...
          (_a = req.body),
            ...
            (rollbackVersion = _a.rollbackVersion);
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            supabase.auth.getUser(req.headers.authorization || ""),
          ];
        case 2:
          (_b = _c.sent()), (user = _b.data), (authError = _b.error);
          if (authError || !user) {
            return [
              2 /*return*/,
