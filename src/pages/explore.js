...
export default function ExploreGalaxy() {
    ...
    return (_jsx("div", { className: "h-screen bg-black text-white", children: _jsx(ForceGraph2D, { graphData: data, nodeLabel: "name", nodeAutoColorBy: "group", linkDirectionalParticles: 2, linkDirectionalArrowLength: 4, onNodeClick: (node) => {
                var _a;
                if ((_a = node.id) === null || _a === void 0 ? void 0 : _a.toString().includes("Tenant")) {
