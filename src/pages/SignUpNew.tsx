...
export default function SignUpNew() {
            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <button onClick={handleRetryLegalAcceptance} className="text-sm text-primary mt-2 hover:underline">
    ...
    return (<SignupLayout>
      <Card className="w-full max-w-lg border-primary/10 shadow-lg">
        ...
        <CardContent>
          {signupError && (<div className="bg-destructive/10 border border-destructive rounded-md p-3 mb-4 text-sm text-destructive">
              <p>{signupError}</p>
              <button onClick={handleTryAgain} className="text-primary hover:underline mt-1 text-sm">
                Try again
              </button>
            </div>)}
      ...
      {showLegalModal && newUser && (<LegalAcceptanceModal isOpen={showLegalModal} userId={newUser.id} onClose={handleModalClose} onAccept={handleLegalAcceptance}/>)}
    </SignupLayout>);
}
