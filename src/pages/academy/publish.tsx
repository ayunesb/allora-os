...
export default function PublishAcademyContent() {
    ...
    return (<div className="container px-4 py-6">
      <DashboardBreadcrumb rootPath="/academy" rootLabel="Academy" rootIcon={<GraduationCap className="h-4 w-4"/>} currentPath="/academy/publish" currentLabel="Publish Content"/>
