      ...
      <div className="flex-1 container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
              ...
              <CardContent>
                <div className="flex flex-col space-y-4">
                  <div className="flex gap-2">
                    <Input placeholder="Ask about Allora AI features, pricing, or how to use it..." value={question} onChange={(e) => setQuestion(e.target.value)} onKeyDown={handleKeyPress} className="flex-1"/>
                  ...
                  {aiAnswer && (<div className="p-4 rounded-lg bg-muted/50">
          ...
          <div className="mt-12 text-center">
            ...
            <a href="mailto:support@allora-ai.com" className="text-primary hover:underline">
              Contact Support
            </a>
          </div>
        </div>
