...
export default function AuditLogs() {
    ...
    return (_jsx("div", { className: "space-y-6", children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { className: "text-xl", children: "Audit Logs" }), _jsx(CardDescription, { children: "Track all system activities and compliance-related events" })] }), _jsxs(CardContent, { children: [_jsx(AuditLogFilters, { actionFilter: actionFilter, setActionFilter: setActionFilter, userFilter: userFilter, setUserFilter: setUserFilter, date: date, setDate: setDate, onExportLogs: handleExportLogs }), _jsx("div", { className: "mt-6", children: _jsx(AuditLogTable, { logs: filteredLogs }) })] })] }) }));
}
