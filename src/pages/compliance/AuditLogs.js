...
export default function AuditLogs() {
    ...
    return (<div className="space-y-6">
      <Card>
        ...
        <CardContent>
          <AuditLogFilters actionFilter={actionFilter} setActionFilter={setActionFilter} userFilter={userFilter} setUserFilter={setUserFilter} date={date} setDate={setDate} onExportLogs={handleExportLogs}/>
          <div className="mt-6">
