            ...
            <ScrollArea className="h-[60vh]">
              <div className="space-y-6 pr-4">
                <section>
                  ...
                  <p>
                    Welcome to Allora AI, a business acceleration platform
                    designed to help businesses make strategic decisions,
                    develop growth strategies, and gain competitive insights.
                ...
                <section>
                  ...
                  <p>
                    By accessing or using Allora AI, you agree to be bound by
                ...
                <section>
                  ...
                  <p>
                    Permission is granted to temporarily use Allora AI for
                    personal or business purposes, subject to the restrictions
                    set forth in these Terms of Service. This license shall
                ...
                <section>
                  ...
                  <p>
                    Subscription fees are charged on a recurring basis. You may
                    cancel your subscription at any time, but no refunds will be
                    issued for the current billing period. We reserve the right
                ...
                <section>
                  ...
                  <p>
                    Allora AI and its original content, features, and
                    functionality are owned by Allora AI, Inc. and are protected
                ...
                <section>
                  ...
                  <p>
                    Your use of Allora AI is also governed by our Privacy
                    Policy, which can be found at{" "}
                    <a href="/privacy" className="text-primary hover:underline">
                      Privacy Policy
                    </a>
                    . By using Allora AI, you consent to the collection and use
                ...
                <section>
                  ...
                  <p>
                    Allora AI is provided "as is" and "as available" without any
                    representations or warranties, express or implied. We make
                ...
                <section>
                  ...
                  <p>
                    In no event shall Allora AI, its directors, employees,
                ...
                <section>
                  ...
                  <p>
                    ...
                    Allora AI immediately, without prior notice or liability,
