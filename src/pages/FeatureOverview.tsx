      ...
      <div className="mt-8 space-y-12">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Access a virtual board of AI executives that provide specialized
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Get personalized strategic overviews and actionable business
            recommendations.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Make calls, send messages, and create customized scripts all from
            one platform.
          </p>
        </section>
      </div>
