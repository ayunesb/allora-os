      ...
      <Card className="p-6 border border-border">
        {connected ? (<div className="space-y-4">
            <div className="rounded-lg border p-4 bg-muted/30 space-y-2">
              ...
              {lastTweet && (<p className="text-xs text-muted-foreground">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="post-wins" checked={autoPostSettings.post_wins} onChange={(e) => handleSettingChange('post_wins', e.target.checked)}/>
                  <label htmlFor="post-wins" className="text-sm">Post agent wins</label>
                </div>
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="post-strategies" checked={autoPostSettings.post_strategies} onChange={(e) => handleSettingChange('post_strategies', e.target.checked)}/>
            ...
            <div className="pt-2 space-y-4">
              <Button size="sm" variant="outline" onClick={handleTestTweet} className="w-full">
                Send Test Tweet
              </Button>
