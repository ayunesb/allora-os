  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      ...
      <p className="text-muted-foreground mb-6">
        Connect your Twitter account to let Allora automatically publish your
        agent wins, strategy launches, and more.
      </p>
        ...
        {connected ? (
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange("post_wins", e.target.checked)
                    }
                  />
                  <label htmlFor="post-wins" className="text-sm">
                    Post agent wins
                  </label>
                </div>
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingChange("post_strategies", e.target.checked)
                    }
                  />
                  <label htmlFor="post-strategies" className="text-sm">
                    Post new strategies
                  </label>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <p className="text-sm mb-4">
              Connect your Twitter account to automatically share updates about
              your business strategies and agent wins. This helps showcase your
              business growth and Allora's impact.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              Note: You'll be redirected to Twitter to authorize this
              connection. No tweets will be posted without your permission.
            </p>
          </div>
        )}
      </Card>
