      ...
      <div className="container max-w-4xl py-8">
        ...
        <Card className="mb-8">
          <CardHeader className="border-b border-border pb-4">
            ...
            <CardDescription>
              How Allora AI ensures compliance with the General Data Protection
              Regulation
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="space-y-6">
              <p>
                At Allora AI, we are committed to ensuring the privacy and
                protection of your data in compliance with the General Data
                Protection Regulation (GDPR). This page outlines how we adhere
                to GDPR principles and what rights you have regarding your
                personal data.
              </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      We only collect and process data that is necessary for the
                      specific purposes we've communicated to you.
                    </p>
                  </div>
                  <div>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p className="mb-4">
              If you are a business customer using our services to process
              personal data, we offer a Data Processing Agreement (DPA) that
              outlines our respective responsibilities under GDPR.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              For more detailed information on our data practices, please refer
              to our:
            </p>
