  ...
  return (
    <div className="container py-6">
      ...
      <p className="text-muted-foreground mb-6">
        Connect Allora AI to your Calendly account to automatically schedule
        meetings and manage your calendar.
      </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your Calendly API key to enable scheduling features in Allora
            AI.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-green-50 text-green-800 rounded-md">
                ...
                <p className="text-sm mt-1">
                  Your Calendly account is now connected to Allora AI. You can
                  now use Calendly features within the application.
                </p>
              </div>
