...
export default function LeadsPage() {
    ...
    return (<div className="space-y-6">
      <LeadsHeader isMobileView={isMobileView} onAddLead={handleAddLead}/>
      <LeadsTable leads={leads} sortBy={sortBy} sortOrder={sortOrder} onSort={handleSort} isMobileView={isMobileView} onStatusUpdate={handleStatusUpdate} onDelete={handleDelete}/>
    </div>);
}
