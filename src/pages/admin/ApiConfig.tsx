...
export default function ApiConfig() {
  ...
  const toggleApiKey = (key) => {
    ...
    toast.success(
      `${key.charAt(0).toUpperCase() + key.slice(1)} API ${!activeApiKeys[key] ? "enabled" : "disabled"}`,
    );
  };
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            navigate(`/admin/api-integrations?service=${key}`)
                          }
                        >
                          Configure
                        </Button>
              ...
              <CardContent>
                <div className="space-y-6">
                  <Alert>
                    ...
                    <AlertDescription>
                      Webhook testing mode is currently active. Events will be
                      logged but not fully processed.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Toggle variant="outline" aria-label="XML" size="sm">
                          XML
                        </Toggle>
                        <Toggle variant="outline" aria-label="YAML" size="sm">
                          YAML
                        </Toggle>
                      </div>
                    </div>
