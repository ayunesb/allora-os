      ...
      <div className="space-y-6">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground">
              Verify all Zapier webhooks are correctly configured and firing on
              business events
            </p>
          </div>
        </div>
        ...
        >
          ...
          <TabsContent value="documentation" className="space-y-4 mt-6">
            <Card className="p-6">
              <h3 className="text-lg font-medium mb-4">
                How to Configure Your Zapier Webhooks
              </h3>

              <div className="space-y-4">
                <p>
                  Allora AI sends webhook events to Zapier for the following
                  events:
                </p>

                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Campaign Launched</strong> - Fired when a new
                    marketing campaign is launched
                  </li>
                  <li>
                    <strong>Lead Added</strong> - Fired when a new lead is added
                    to the system
                  </li>
                  <li>
                    <strong>Strategy Approved</strong> - Fired when a business
                    strategy is approved
                  </li>
                  <li>
                    <strong>Lead Converted</strong> - Fired when a lead is
                    converted to a customer
                  </li>
                  <li>
                    <strong>Revenue Milestone</strong> - Fired when a revenue
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>Copy the webhook URL provided by Zapier</li>
                  <li>
                    Go to the "Configure" tab and paste the URL in the Zapier
                    webhook field
                  </li>
                  <li>
                    Set up your desired action in Zapier (e.g., send an email,
                    create a task)
                  </li>
                  <li>
                ...
                <p className="mt-4">
                  For company-specific configuration, please contact your
