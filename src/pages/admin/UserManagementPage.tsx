...
export default function UserManagementPage() {
  ...
  const [users, setUsers] = useState([
    { id: 'user-1', name: 'John Doe', email: 'john@example.com', role: 'admin', company_id: 'company-1' },
    { id: 'user-2', name: 'Jane Smith', email: 'jane@example.com', role: 'user', company_id: 'company-2' },
    { id: 'user-3', name: 'Bob Johnson', email: 'bob@example.com', role: 'user', company_id: 'company-3' }
  ]);
