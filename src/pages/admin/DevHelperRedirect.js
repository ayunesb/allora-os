    ...
    return (<div className="container mx-auto py-10">
      <div className="max-w-md mx-auto">
        <Card>
          ...
          <CardContent>
            <AdminCheckHandler user={user} roleRequired="admin" adminOnly={true} hasInitialized={hasInitialized}>
              {(isUserAdmin, adminCheckDone) => (<div className="space-y-4">
                  {!adminCheckDone ? (<div className="flex items-center justify-center py-6">
                      <Loader className="h-8 w-8 animate-spin text-primary"/>
                      <span className="ml-2 text-muted-foreground">Verifying admin access...</span>
                    </div>) : isUserAdmin ? (<div className="bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 p-4 rounded-md">
                    ...
                    </div>) : (<div className="bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 p-4 rounded-md">
                      <div className="flex items-center">
                        <Shield className="h-5 w-5 mr-2"/>
          ...
          <CardFooter className="flex flex-col gap-2">
            <Button onClick={() => navigate('/dev-admin-helper')} className="w-full">
              Go to Admin Helper
            </Button>
