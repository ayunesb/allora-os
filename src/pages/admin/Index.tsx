  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (companiesData.error) throw new Error(`Error fetching company data: ${companiesData.error.message}`);
        if (campaignsData.error) throw new Error(`Error fetching campaign data: ${campaignsData.error.message}`);
        if (leadsData.error) throw new Error(`Error fetching lead data: ${leadsData.error.message}`);
        ...
        if (subError) throw new Error(`Error fetching subscription data: ${subError.message}`);
