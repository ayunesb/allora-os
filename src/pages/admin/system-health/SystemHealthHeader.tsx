...
export default function SystemHealthHeader() {
    ...
    return (<div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button variant="outline" size="sm" className="gap-1" onClick={() => navigate('/admin/diagnostics')}>
