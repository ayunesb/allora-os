    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between text-sm mb-1">
                ...
                <span>
                  {services.filter((s) => s.status !== "healthy").length} Issues
                </span>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">Avg: 87ms</span>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs
          ...
          value={activeTab as TabsTriggerProps["value"]}
