  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <TypographyP>
          Configure Stripe integration for payment analytics and management
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your Stripe secret key to enable payment analytics through the
            AI agent.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {isKeySet ? (
            <Alert className="bg-green-50 border-green-200">
              ...
              <AlertDescription>
                Your Stripe secret key is configured. The AI agent can now
                access Stripe data.
              </AlertDescription>
            </Alert>
          ) : (
          ...
          <div className="mt-4">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Find this in your Stripe Dashboard under API Keys. Use your secret
              key (not publishable key).
            </p>
          </div>
      ...
      {isKeySet && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Try out some sample queries to test the Stripe analytics
              integration.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col space-y-2">
              ...
              <Input
                ...
                } // Ensured proper state update
              />
              <p className="text-xs text-muted-foreground">
                Try queries like "total revenue", "active subscriptions", or
                "refunds this week"
              </p>
            </div>
