...
const NotionIntegration = () => {
    ...
    const handleConnect = async (data) => {
        ...
        try {
            ...
            const { data: response, error } = await supabase.functions.invoke('notion-tool', {
                body: {
    ...
    return (<div className="container py-6">
      ...
      <Card>
        ...
        <CardContent>
          {!isConnected ? (<form onSubmit={handleSubmit(handleConnect)} className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="apiKey" className="text-sm font-medium">
                  Notion API Key
                </label>
                <Input id="apiKey" type="password" placeholder="secret_..." {...register('apiKey', { required: true })}/>
