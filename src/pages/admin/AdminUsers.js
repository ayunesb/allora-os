...
export default function AdminUsers() {
    ...
    return (<PageErrorBoundary pageName="User Management">
      <div className="space-y-6">
        <UserManagementHeader companies={companies} loadingCompanies={loadingCompanies} onUserAdded={handleUserAdded}/>
        
        <UserTable users={users} isLoading={isLoading} onUpdateUser={handleUpdateUser} onDeleteUser={handleDeleteUser}/>
      </div>
    </PageErrorBoundary>);
}
