    ...
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete all necessary steps before launching
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Estimated timeline for launch activities
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:w-0.5 before:-translate-x-1/2 before:h-full before:bg-muted">
            ...
            <div className="relative pl-8">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="w-fit flex items-center gap-1 bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400"
                >
                  <Clock className="h-3 w-3" />
                  In Progress
                </Badge>
