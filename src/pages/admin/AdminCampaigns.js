...
export default function AdminCampaigns() {
    ...
    const columns = [
        ...
        },
        {
            ...
            title: "Date Range",
            hideOnMobile: true,
            render: (item) => <span>{item.startDate} to {item.endDate}</span>,
        },
        {
            key: "budget",
            title: "Budget",
            hideOnMobile: true,
            render: (item) => <span>{item.budget}</span>,
        },
        {
            key: "platform",
            title: "Platform",
    ...
    return (<div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <ResponsiveTable data={mockCampaigns} columns={columns} mobileColumns={mobileColumns} actions={actions}/>
        </CardContent>
      </Card>
    </div>);
}
