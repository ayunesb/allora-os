    ...
    <div className="container mx-auto py-8 space-y-8">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will make Allora AI available to all users. Ensure all
                  critical implementation items are complete before proceeding.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700 text-sm">
              This dashboard tracks the implementation progress for Allora AI
              launch. Complete all critical items before launching the platform.
              Run the validation check to ensure all systems are ready.
            </p>
          </div>
        </div>
      </Card>
      ...
      <Tabs defaultValue="checklist" className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="executive-collective">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Implementation of 100 virtual executives with specialized
                expertise
              </p>
            </div>
            ...
            <div className="bg-secondary/40 border border-border/50 rounded-lg p-6 text-center">
              <h3 className="text-xl font-bold mb-2">
                Executive Collective Implementation
              </h3>
              <p className="text-muted-foreground mb-6">
                The executive collective feature is being implemented as part of
                the launch plan. Check the Checklist tab for specific
        ...
        <TabsContent value="technical" className="mt-6">
          <div className="space-y-6">
            ...
            <div className="bg-secondary/40 border border-border/50 rounded-lg p-6 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Technical infrastructure implementation is tracked as part of
                the launch plan. Check the Checklist tab for specific
                implementation items.
              </p>
              <Button
