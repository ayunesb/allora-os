...
export default function ClearbitIntegration() {
  ...
  const runTest = async () => {
    if (!testValue.trim()) {
      toast.error(
        `Please enter a ${activeTab === "company" ? "domain" : "email"} to test`,
      );
      return;
    }
    setTestResult(null);
  ...
  return (
    <div className="container space-y-6 py-8">
      ...
      <TypographyP>
        Connect Clearbit to enrich leads and companies with detailed
        information. This integration enables AI agents to look up company and
        person data.
      </TypographyP>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter your Clearbit API key to connect to the Clearbit Enrichment
            API.
          </CardDescription>
        </CardHeader>
        <CardContent>
