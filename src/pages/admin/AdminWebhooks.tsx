      ...
      <Tabs defaultValue="active" className="w-full">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        id="user-events"
                        placeholder="https://your-server.com/webhooks/users"
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        id="system-events"
                        placeholder="https://your-server.com/webhooks/system"
                      />
                      <Button variant="outline" size="sm">
                        Test
                      </Button>
        ...
        <TabsContent value="logs">
          <Card>
            ...
            <CardContent>
              <TypographyP>
                No webhook events recorded yet. They will appear here once
                activity begins.
              </TypographyP>
            </CardContent>
          </Card>
