...
export default function CompanySettings() {
  const { companies, isLoading, loadCompanies, updateCompany } =
  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        >
          <TabsList
            className={`grid w-full ${isMobileView ? "grid-cols-2" : "grid-cols-4"}`}
          >
              ...
              <CardContent>
                <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-md border-muted-foreground/20">
                  <p className="text-center text-muted-foreground">
                    Team management settings will be implemented in a future
                    update
                  </p>
                </div>
              </CardContent>
          ...
          <TabsContent value="preferences" className="space-y-4 mt-6">
            <Card className="p-6">
              ...
              <CardContent>
                <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-md border-muted-foreground/20">
                  <p className="text-center text-muted-foreground">
                    System preference settings will be implemented in a future
                    update
                  </p>
                </div>
              </CardContent>
