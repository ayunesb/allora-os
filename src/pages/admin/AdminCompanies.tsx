...
export default function AdminCompanies() {
    ...
    return (<PageErrorBoundary pageName="Company Management">
      <div className="space-y-6">
        <CompanyHeader onAddCompanyClick={() => setIsCreateDialogOpen(true)}/>
        
        <CompanyTable companies={companies} isLoading={isLoading} onViewUsers={handleViewUsers} onEditCompany={handleEditCompany} onDeleteCompany={handleDeleteCompany}/>
        
        <CreateCompanyDialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen} onCreateCompany={handleCreateCompany}/>
      </div>
    </PageErrorBoundary>);
}
