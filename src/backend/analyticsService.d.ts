...
export declare const getCompanyUserAnalytics: (
  companyId: string,
) => Promise<CompanyAnalytics>;
export declare const getConsultationAnalytics: (
  companyId: string,
) => Promise<ConsultationAnalytics>;
export declare const getDebateAnalytics: (
  companyId: string,
) => Promise<DebateAnalytics>;
export declare const getLeadAnalytics: (
  companyId: string,
) => Promise<LeadAnalytics>;
export declare const getPredictiveAnalytics: (
  companyId: string,
) => Promise<PredictiveAnalytics>;
export declare const getSystemAnalytics: () => Promise<SystemAnalytics>;
export declare const getCompanyDashboardAnalytics: (
  companyId: string,
) => Promise<{
