 ...
 */
var sendSMS = function (to, body, companyId, leadId) {
          ...
          return [
            ...
            client_1.supabase.functions.invoke("twilio", {
              body: {
                ...
                body: body,
                leadId: leadId,
                companyId: companyId, // Pass company ID for tracking
              },
            }),
          ];
        case 2:
 ...
 * @returns A promise with the result of the operation
 */
var sendBulkSMS = function (messageType, body, companyId) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          error_2 = _b.sent();
          console.error("Failed to send bulk SMS:", error_2);
          return [
            2 /*return*/,
            {
              success: false,
