...
export declare const updateUserAsAdmin: (userId: string, data: AdminUserUpdateData) => Promise<boolean>;
export declare const updateCompanyAsAdmin: (companyId: string, data: AdminCompanyUpdateData) => Promise<boolean>;
export declare const deleteUserAsAdmin: (userId: string) => Promise<boolean>;
export declare const deleteCompanyAsAdmin: (companyId: string) => Promise<boolean>;
