...
exports.getCompanyDebateSessions = exports.saveDebateSession = void 0;
var sonner_1 = require("sonner");
// Save a debate session to the database (mock implementation)
var saveDebateSession = function (session) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      try {
        ...
        sessionId = "debate-".concat(Date.now());
        sonner_1.toast.success("Debate session saved successfully");
        return [2 /*return*/, sessionId];
      } catch (error) {
        console.error("Error saving debate session:", error.message);
        sonner_1.toast.error("Failed to save debate: ".concat(error.message));
...
exports.saveDebateSession = saveDebateSession;
// Export a function to get debate sessions for a company (mock implementation)
var getCompanyDebateSessions = function (companyId) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      try {
...
exports.getCompanyDebateSessions = getCompanyDebateSessions;
