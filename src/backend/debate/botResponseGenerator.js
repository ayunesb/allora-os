...
export const generateBotResponse = (bot_1, topic_1, ...args_1) => __awaiter(void 0, [bot_1, topic_1, ...args_1], void 0, function* (bot, topic, riskAppetite = "medium", businessPriority = "growth") {
    try {
...
const getPersonalizedFallbackResponse = (bot, topic, riskAppetite, businessPriority) => {
