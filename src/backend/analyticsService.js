...
export const getCompanyUserAnalytics = async (companyId) => {
    try {
...
export const getConsultationAnalytics = async (companyId) => {
    try {
        // In a real implementation, this would query the Supabase database
        // For now, return mock data
        return {
...
export const getDebateAnalytics = async (companyId) => {
    try {
        // In a real implementation, this would query the Supabase database
        // For now, return mock data
        return {
...
export const getLeadAnalytics = async (companyId) => {
    try {
        // In a real implementation, this would query the Supabase database
        // For now, return mock data
        return {
...
export const getPredictiveAnalytics = async (companyId) => {
    try {
...
export const getCompanyDashboardAnalytics = async (companyId) => {
    try {
        const [userAnalytics, consultationAnalytics, debateAnalytics, leadAnalytics, predictiveAnalytics] = await Promise.all([
