...
exports.sendCampaignEmail = exports.sendEmail = void 0;
...
var sendEmail = function (_a) {
  return __awaiter(void 0, [_a], void 0, function (_b) {
    var session, _c, data, error, error_1;
    var to = _b.to,
      subject = _b.subject,
      companyName = _b.companyName,
      htmlBody = _b.htmlBody,
      textBody = _b.textBody,
      templateId = _b.templateId,
      templateModel = _b.templateModel,
      leadId = _b.leadId;
 ...
 * @returns A promise with the result of the operation
 */
var sendCampaignEmail = function (_a) {
  return __awaiter(void 0, [_a], void 0, function (_b) {
    var session, _c, data, error, error_2;
    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 3:
          error_2 = _e.sent();
          console.error("Failed to send campaign emails:", error_2);
          return [
            2 /*return*/,
            {
              success: false,
