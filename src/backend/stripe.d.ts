...
export declare const createCheckoutSession: (priceId: string, successUrl?: string, cancelUrl?: string) => Promise<CreateCheckoutSessionResponse>;
export declare const createCustomerPortalSession: (returnUrl?: string) => Promise<CreateCustomerPortalResponse>;
...
export declare const changeSubscriptionPlan: (subscriptionId: string, newPriceId: string) => Promise<{
    success: boolean;
    error?: string;
}>;
