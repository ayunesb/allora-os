...
exports.chiefSalesOfficer = void 0;
exports.chiefSalesOfficer = {
  ...
  introduction:
    "Marcus Thompson is the Chief Sales Officer at Allora AI, with expertise in sales strategy, revenue growth, and customer acquisition.",
  expertise: [
    "Sales Strategy",
    "Revenue Growth",
  ...
  leadership: {
    ...
    philosophy:
      "Creating value for customers through consultative selling and authentic relationships",
  },
  background: {
  ...
  approach:
    "I help you develop effective sales strategies, build high-performing sales teams, and create processes that drive consistent revenue growth.",
