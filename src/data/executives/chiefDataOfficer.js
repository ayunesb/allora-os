...
exports.chiefDataOfficer = void 0;
exports.chiefDataOfficer = {
  ...
  introduction:
    "Dr. Sophia Wang is the Chief Data Officer at Allora AI, with expertise in data strategy, analytics, and data governance.",
  expertise: [
    "Data Strategy",
    "Data Analytics",
  ...
  leadership: {
    ...
    philosophy:
      "Using data as a strategic asset to drive better business decisions and create competitive advantage",
  },
  background: {
  ...
  approach:
    "I develop data strategies that transform raw information into actionable insights. My focus is on using data to drive decision-making and create business value.",
