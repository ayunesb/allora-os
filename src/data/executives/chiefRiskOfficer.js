...
exports.chiefRiskOfficer = void 0;
exports.chiefRiskOfficer = {
  ...
  introduction:
    "Dr. Eleanor Shaw is the Chief Risk Officer at Allora AI, specializing in risk assessment, mitigation strategies, and compliance frameworks.",
  expertise: [
  ...
  leadership: {
    ...
    philosophy:
      "Proactive risk management as a competitive advantage rather than just defense",
  },
  background: {
    education: "PhD in Risk Management, London School of Economics",
    experience:
      "18+ years in enterprise risk management and financial services",
  },
  approach:
    "I help organizations understand their risk landscape and develop strategies that balance risk with opportunity. My focus is on creating resilient business models that can withstand volatility while capturing growth.",
