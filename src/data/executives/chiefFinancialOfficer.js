export const chiefFinancialOfficer = {
    ...
    introduction: 'Jennifer Chen is the Chief Financial Officer at Allora AI, with expertise in financial strategy and business optimization.',
    expertise: [
        'Financial Strategy',
        'Capital Allocation',
        'Financial Analysis',
    ...
    leadership: {
        ...
        philosophy: 'Creating sustainable business value through disciplined financial management'
    },
    background: {
        education: 'MBA in Finance, Wharton School of Business',
        experience: '18+ years in financial leadership and strategic planning'
    },
    approach: 'I provide data-driven financial analysis and guidance to help you make sound financial decisions that drive business growth and sustainability.',
