...
exports.chiefMarketingOfficer = void 0;
exports.chiefMarketingOfficer = {
  ...
  introduction:
    "Michael Rodriguez is the Chief Marketing Officer at Allora AI, with expertise in marketing strategy and brand development.",
  expertise: [
    "Marketing Strategy",
    "Brand Development",
    "Digital Marketing",
  ...
  leadership: {
    ...
    philosophy:
      "Creating authentic connections between brands and customers through compelling narratives",
  },
  background: {
  ...
  approach:
    "I help you build a strong brand identity and develop marketing strategies that connect with your target audience and drive business growth.",
